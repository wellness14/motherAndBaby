 ...
 <!-- #include virtual = "/etc_work/mnb_app/nav.asp"-->
    ...
    <div class="container">
			...
			<input type="hidden" id="mode" name="mode" value="<%=mode%>">
				...
				<div class="input pt_5">
					<input type="text" name="hp_cert" id="cert_num" value="" style="padding-left:15px;height:30px;width:116px;border:1px solid #C8C8C8;color:#C8C8C8;" placeholder="인증번호입력" />
				...
				<div class="chk_txt">
					<br><span class="chk_area"><input type="checkbox" name="over14_agree1" id="over14_agree1" value="Y"/> 만 14세 이상입니다.</span>
				</div>
