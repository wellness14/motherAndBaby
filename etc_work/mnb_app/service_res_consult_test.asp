		...
		<input type="hidden" name="mode" id="mode" value="<%=mode%>" />
			...
			<div class="info_box_011" style="background:#fff;"> 
				<div class="input" style="padding-left:20px;">
					...
					<input type="text" name="mem_nm" id="mem_nm" style="width:185px;height:30px;border:1px solid #C8C8C8;font-size:12pt;font-weight:350;padding-left:15px;color:#888888" placeholder="이름을 입력하세요" <%If uId <> "" Then %> value="<%=uname%>" <% Else %> value="" <% End If %>/>  
				</div>
...
<%End if%>
				<div class="input" style="padding-left:20px;">
					<div class="input2">
						<span style="margin-right:4px; color:#888888;">상담가능날짜</span>  <input type="text" id="datepicker" name="psb_con_date" value="" class="info_input_04" style="width:185px;margin-left:3px;height:30px;color:#888888" placeholder="날짜를 입력하세요" readonly>
					</div>
				</div>

				<div class="input" style="padding-left:20px;">
					<div class="input2">
						<span style="margin-right:6.8px;">상담가능시간</span>
						...
						<select class="select4"  name="con_minute" id="con_minute" class="info_hp1" style="padding-left:15px;background:#fff;height:30px;width:53px;color:#888888;font-size:12pt;width:88px;">
							<option value="">선택</option> 
				...
				<div class="input" style="padding-left:20px;text-align:center;">
					<div class="input2">
						<textarea rows="10" cols="5" class="textarea_01" name="contents" style="width:287px;" placeholder="상담내용입력"></textarea>
					</div>
				</div> 
