 ...
 <!-- #include virtual = "/etc_work/mnb_app/nav.asp"-->
    ...
    <div class="container">
		...
		<div class="plan_input">
			<a href="care_service_1.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a> 
		</div> 
		...
		<div class="plan_input">
			<a href="care_service_2.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a>
		</div> 
		...
		<div class="plan_input">
			<a href="care_service_vip.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a>
		</div> 
		...
		<div class="plan_input">
			<a href="care_service_private.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a>
		</div>  
		...
		<div class="plan_input">
			<a href="care_service_twin.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a>
		</div> 
		...
		<div class="plan_input">
			<a href="care_service_working_mom.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a>
		</div> 
		...
		<div class="plan_input">
			<a href="care_service_over.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a>
		</div> 
		...
		<div class="plan_input">
			<a href="care_service_over_age.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a>
		</div> 
		...
		<div class="plan_input">
			<a href="care_service_home.asp"><input type="button" name="plan_btn" id="plan_btn" class="plan_input_01" value="자세히보기"  class="btn-example"  /></a>
		</div> 
