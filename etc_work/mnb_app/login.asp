 ...
 <!-- #include virtual = "/etc_work/mnb_app/nav.asp"-->
  <!-- <div style="text-align:center; line-height:51px;color:#ffffff;font-weight:350;font-size:20pt;margin:0 auto;background-color:#ef4e6f;">로그인</div> -->
    ...
    <div class="container">
		...
		<div class="main img" >
			 <img src="img/logo_12.png" style="width:230px; height:60px;" />
		</div>
		...
		<form id="LoginForm" name="LoginForm" method="post" action="login_sql.asp">
			...
			<div class="login_input">
					<input type="checkbox" name="login_auto" id="login_auto" class="check_box_1" value="Y" /> <span class="login_text_1">자동로그인</span><span style="margin-right:210px;"></span>
			</div>
