...
<html lang="en">
  ...
  <!-- #include virtual = "/etc_work/mnb_admin_app/nav.asp"--> 
    ...
    <div class="container"> 
		...
		<div style="padding:20px;margin-bottom:20px;width:100%; border:1px solid #ef4e6f;-webkit-border-radius: 10px 10px 10px 10px; border-radius: 10px 10px 10px 10px;"> 
			<form name="setting_form" id="setting_form" method="post" action="service_request_sql.asp">
				...
				<% else %>
					<div class="input">
						<span class="input2_title">이름</span><input type="text" name="user_name" id="user_name" class="input_02" placeholder="이름(실명)" /> 
					</div>
				<%end If %>
					<div class="input">
					...
					<select id="part" name="part"  onChange="fncSetImg(this.value);" class="textarea" style="height:35px;">
					...
					<div class="input">
							<span class="input2_title">조리원</span> <input type="radio" name="radio3" id="radio3" value="이용함"  <%=fncSetCheckBox("이용함",MS_CNLKBN)%> /> 이용함 
							<span style="margin-left:20px;"></span><input type="radio" name="radio3" id="radio3" value="이용안함"  <%=fncSetCheckBox("이용안함",MS_CNLKBN)%> /> 이용안함 
					</div>
					<div class="input">
					...
					<div class="input">
						...
						<div id="view_3" style="display:block;margin-left:105px;" >
								...
								<input type="checkbox" name="unique_1" id="unique_3" value="임신성 당뇨"	<%If InStr(MS_UNIQUE,"임신성 당뇨") > 0 Then%>checked<%End If%> /> 임신성 당뇨 
					...
					<div class="join_box_01_sub">
						<div id="view_3" style="display:block;margin-left:105px;" ><input type="text" name="hospital_post" id="hospital_post" class="setting_in_text_02" value="<%=hospital_post%>"  placeholder="우편번호"/> <input type="button" name="post_btn" id="post_btn" class="setting_btn" value="주소찾기" />
						</div>
					</div> 
					<div class="join_box_02_sub">
						<div id="view_3" style="display:block;margin-left:105px;" >
							<input type="text" name="hospital_address1" id="hospital_address1" class="setting_in_text_5" value="<%=hospital_address1%>" placeholder="주소를입력하세요"/> 
						</div>
					</div> 

					<div class="join_box_01_sub">
						<span class="input2_title">상담내용</span><textarea rows="10" cols="5" class="textarea_01" name="contents" placeholder="내용입력"><%=MS_CONTENT%></textarea>
					</div> 
				...
				<div class="input2">
					...
					<input type="text" id="datepicker3" name="birth" value="<%=birth_ymd%>" placeholder="생년월일을 입력하세요."> 
				</div>
