...
'---------------------------------------------------------
	...
	strWhere = " WHERE MR_CNLKBN='N'  and   (SELECT CONVERT(varchar(30), GETDATE(), 112))  >  MR_SERVICEEDT and MR_PAY_STATE = '결제완료' "
...
<body>
	<div id="container">
		...
		<div class="write">
			...
			<input type="hidden" name="page_name" value="service_end_list">
			<div class="selection">
				검색:
...
%>
			<tr onclick="location.href='./mobile_member_reser_ins.asp?idx=<%=idx%>&page_name=service_end_list'" style="cursor:pointer;">
