...
<br/>
					<input type="text" name="addr_1" class="textarea" size="30" value="<%=arrList(7,0)%>" valid="E|A=주소를 입력해 주세요"/><br/>
					<input type="text" name="addr_2" class="textarea" size="30" value="<%=arrList(8,0)%>" valid="E|A=상세주소를 입력해 주세요"/>
				</td>
			</tr>
			<tr>
				<th>관리사주민번호</th>	
			...
			<tr>
				<th>상담내용</th>	
				<td><textarea name="textarea" style="width:270px;height:200px;" valid="E|A=상담내용을 입력해 주세요"><%=arrList(18,0)%></textarea></td>
			</tr>
			</thead>
			</table>
			</form>
...
<script type="text/javascript">
	...
	frm.submit(function(){
		...
		"target" : "ifrm",
		"action" : "/info/mobile_info_01_sql.asp?<%=strLnkUrl%>"
	});
</script>
