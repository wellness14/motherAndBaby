...
<body>
	<div id="container">
		...
		<div class="write">
			...
			<input type="hidden" name="page_name" value="cancel_list">
			<div class="selection">
				검색:
...
%>
			<tr onclick="location.href='./mobile_member_reser_ins.asp?idx=<%=idx%>&page_name=cancel_list'" style="cursor:pointer;">
