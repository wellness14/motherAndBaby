			...
			<tr>
				...
				<td>
					<select name="cate"  id="cate">
						...
						<option value="식료품"<%=fncSetSelectBox("식료품",arrList(2,0))%>>식료품</option>
						<option value="의류"<%=fncSetSelectBox("의류",arrList(2,0))%>>의류</option>
						<option value="장난감"<%=fncSetSelectBox("장난감",arrList(2,0))%>>장난감</option>
						<option value="기타"<%=fncSetSelectBox("기타",arrList(2,0))%>>기타</option>
					</select>
				</td>
			</tr>
			<tr>
