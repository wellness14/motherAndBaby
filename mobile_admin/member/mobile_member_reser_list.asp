		...
		<div class="write">
			...
			<div class="selection">
				...
				<a onClick="location.href='./mobile_member_reser_list.asp';" style="cursor:pointer;" class="button">전체리스트</a>
					...
					<a onClick="location.href='./mobile_member_reser_ins.asp'" style="cursor:pointer;" class="button">등록</a>
...
%>
			<tr onclick="location.href='./mobile_member_reser_ins.asp?idx=<%=idx%>'" style="cursor:pointer;">
