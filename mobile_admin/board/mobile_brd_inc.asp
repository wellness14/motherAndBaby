<!-- #include virtual="/mobile_admin/common/asp/mobile_checkUser.asp"-->
<%
'-------------------------------------------------------------------------------
'	사용자 정보
...
'-------------------------------------------------------------------------------
	...
	urlList = "/mobile_admin/board/mobile_brd_list.asp"
	urlView = "/mobile_admin/board/mobile_brd_view.asp"
	urlIns = "/mobile_admin/board/mobile_brd_ins.asp"
	urlReply = "/mobile_admin/board/mobile_brd_reply.asp"
	urlSql = "/mobile_admin/board/brd_sql.asp"
