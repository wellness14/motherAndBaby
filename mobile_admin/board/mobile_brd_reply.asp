...
<body>
	<div id="container">
		...
		<div class="write">
			...
			<tr>
				<th>내용</th>	
				<td><textarea name="content1" style="width:300px; height:200px;" disabled="true"><%=content%></textarea></td>
			</tr>
			<% If file_cnt > 0 Then %>
			<tr>
				<th>첨부파일</th>
			...
			<tr>
				<th>제목</th>
				<td><input type="text" name="title" size="30" value="<%=re_title%>" valid="E|M=200|A=답변 제목을 입력해 주세요"></td>
			</tr>
			<tr>
				<th>내용</th>	
				<td><textarea name="content" style="width:300px; height:200px;" valid="E|A=답변내용을 입력해 주세요"><%=re_content%></textarea></td>
			</tr>
			</form>
			</thead>
			</table>

			<table border="0" cellpadding="0" cellspacing="0" bgcolor="white" style="width:300px; height:100px;">
				<tr>
					<td align="center">
