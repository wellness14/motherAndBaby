...
<body>
	<div id="container">
		...
		<div class="write">
			...
			<tr>
				<th>Email</th>
				<td><input type="text" name="email" size="30" value="<%=email%>" valid="E|M=30|A=이메일을 입력해 주세요"></td>
			</tr>
			<% If brd_type = "1" Then %>
			<tr>
				<th>분류</th>
			...
			<tr>
				<th>제목</th>
				<td><input type="text" name="title" size="30" value="<%=title%>" valid="E|M=200|A=제목을 입력해 주세요"></td>
			</tr>
			<tr>
				<th>내용</th>	
				<td>
					<textarea name="content" id="content" style="width:200px; height:200px; display:none;"><%=content%></textarea>
				</td>
			</tr>
			<% If file_cnt > 0 Then %>
			<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" bgcolor="white" style="width:350px; height:100px;">
				<tr>
					<td align="center">
...
<script type="text/javascript">
    try {
        ...
        nhn.husky.EZCreator.createInIFrame({
            ...
            sSkinURI: "/common/SmartEditor2/mobile_SmartEditor2Skin.html?PopUpUrl=" + ImgPopUrl,
