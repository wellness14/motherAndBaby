...
<body>
	<div id="container">
		...
		<div class="write">
			...
			<tr>
				<th>내용</th>	
				<td><textarea name="content1" style="width:280px; height:200px; overflow-y:scroll;" readonly><%=content%></textarea></td>
			</tr>
		...
		%>
			...
			<tr>
				<th>내용</th>
				<td><textarea name="content1" style="width:300px; height:200px; overflow-y:scroll;"  readonly><%=re_content%></textarea></td>
			</tr>
		<%
			Next 
		%>
