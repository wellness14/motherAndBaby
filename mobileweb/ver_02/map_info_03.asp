...
<%
				...
				area(0) = "계양구지사"
				area_addr(0) = "서울특별시 강남구 선릉로120길 5 동곡빌딩 3층 마더앤베이비"
				...
				area(4) = "부평구지사"
				area_addr(4) = "서울특별시 강남구 선릉로120길 5 동곡빌딩 3층 마더앤베이비"
				area_tel(4) = "02-557-3579"
				...
				area(5) = "서구지사"
				area_addr(5) = "서울특별시 강남구 선릉로120길 5 동곡빌딩 3층 마더앤베이비"
