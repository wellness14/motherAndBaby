...
<head>
	...
	<link rel="stylesheet" href="http://wi.momcho.co.kr/css/m/pccs/swiper.min.css">
	<script src="http://wi.momcho.co.kr/js/m/pccs/swiper.min.js"></script>
			  ...
			  <div class="modal-body" style="text-align:center; padding:0px">
					<div class="swiper-container">
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide" onclick="window.location.href = 'board_01_view.asp?idx=46&brd_id=EVENT&menuCode1=50000&menuCode2=E'; void(0);">
								<img src="/mobileweb/html/images/branch_open01_mobile.jpg"  style="width:100%;"/>
							</div>
						</div>
