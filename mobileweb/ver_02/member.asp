...
<div id="wrap">
	...
	<div id="container" class="p10">
		...
		<div style="background-color:#F6F6F6;" class="tal pb50 pl5">
			...
			<div class="mt20">
				<img src="/image/text_0018.jpg" width="74" height="20" />
				<label>
					<select name="childbirth_y" class="textarea natal_year">
						<option value="">년</option>
				...
				<label>
					<select name="childbirth_m" class="textarea natal_month">
						<option value="">월</option>
					<% For num=1 To 12 %>
						<option value="<%=num%>"><%=num%>월</option>
					<% Next %>
				...
				<label>
					<select name="childbirth_d" class="textarea natal_day">
						<option value="">일</option>
					<% For num=1 To 31 %>
						<option value="<%=num%>"><%=num%>일</option>
					<% Next %>
			...
			<div class="mt20">
				<img src="/mobileweb/html/images/text_0016.jpg" /><input type="text" id="post" name="post" class="textarea" size="6" readonly valid="E|A= 우편번호를 입력해 주세요"/> <img src="/mobileweb/html/images/bt_0004.jpg" border="0" align="absmiddle" id="post_btn" style="margin-top:12px;cursor:pointer;" border="0"  valign="bottom" /><br>
				<span style="margin-left:74px;"></span> <input type="text" id="address1" name="address1" class="textarea"  readonly valid="E|A= 주소를 입력해 주세요"/><br>
...
2. '회사'는 회원에 대하여 보다 향상된 서비스 제공을 위해 아래의 제휴업체에서 제공하는 메일 및 기타 서비스를 제공할 수 있으며, 회원은 이에 동의합니다.
가. 애드온컴퍼니
나. 매일유업
다. 더넥스트웨이브,
라. 더넥스트씨
...
4. '본 이용약관에 동의함으로 마더앤베이비 이용약관을 동의함을 의미합니다' '마더앤베이비는 고객의 동의를 얻어' 고객의 동의하에 회사에서 소개한 산모 신생아 건강관리사의 서비스 비용을 관리사에게 대지급을 할 수 있습니다. 이에 따른 책임은 회사는 면책됩니다.
...
1. '마더앤베이비'의 정보는 회원의 동의('개인정보취급방침')를 통하여 웰니스인텔리전스가 운영하는 '맘앤샵(www.momnshop.com)'의 홈페이지에 개인정보(아이디, 비밀번호, 이름, 성별, 생년월일, 이메일, 휴대폰번호, 일반전화번호, 주소)를 연동하게 됩니다.

2. '맘앤샵'(이하 '몰'이라 한다)이란 웰니스인텔리전스 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.

제 27조(구매중개)

1. 서비스로부터 연결(링크)된 '몰'은 웰니스인텔리전스회사가 운영하는 쇼핑몰로서 회사는 쇼핑몰과의 연결을 제공하며, 쇼핑몰의 운영 및 관리, 물품(컨텐츠 포함. 이하 같습니다)의 판매, 배송 및 환불 등에 대한 모든 책임은 회사 부담합니다.

2. 회원이 '몰'에서 물품을 구매 또는 이용하는 경우 약관, 구매 및 이용절차, 대금결제, 배송, 반품, 교환등 물품 구매 및 이용과 관련된 일체의 절차는 '몰'의 절차에 따라야 하며, 회사는 회원의 물품 구매 또는 이용의 절차를 준비합니다.

3. 회원이 '몰'에서 물품을 구매 또는 이용하는 과정에서 '몰'에 제공한 회원정보, 결제정보(신용카드번호, 은행계좌번호 등)등의 분실, 도난, 유출, 변조 등에 대한 모든 책임은 회사가 부담합니다, 단 회사는 이에 대해 고의 또는 과실이 없는 한 책임을 부담하지 않습니다.
...
6.	컴퓨터통신, 인터넷 로그기록자료, 접속지 추적자료: 3개워
...
- 통계작성, 학술연구 또는 시장조사 등을 위하여 필요한 경우로써 특정개인을 식별할 수 없는 형태로 제공하는 경우
-관련법에 의거 적법한 절차에 의한 정부기관의 요청이 있는 경우
 1) 회원님께서 온라인상의 게시판등을 통해 자발적으로 제공해 주신 개인정보는 제3자가 수집하여 사용할 수 있음을 염두하시고 주의하시기 바랍니다.
2_ 회사는 회원님에 대하여 보다 더 질 높은 서비스 제공 등을 위해 동의를 하신 회원님의 개인정보를 제 3자 제공과 같이 제 3자에게 제공하고 있습니다.
...
마더앤베이비 사회서비스 : 산후도우미 바우처 관련 수행 업무 운영등
애드온컴퍼니 : 마더앤베이비 고지사항 및 이벤트 등 광고성 정보전달 및 이벤트 대행등
미앤채 힐링맘스 : 모유수유 및 바디마사지등
...
1. 개인정보를 제공받는 자 : 웰니스인텔리전스㈜가 운영하는 '맘초'서비스와 제휴된 산후조리원들

2. 개인정보를 제공받는 자의 개인정보 이용목적 : 산후조리원의 영업용 아웃바운드콜을 위한 정보제공

3. 제공하는 개인정보의 항목 : 성명 / 핸드폰번호 / 주소 / 이메일 / 출산예정일

4. 개인정보를 제공받는 자의 개인정보 보유 및 이용 기간 : 위탁업체 제공일로부터 1년

5. 동의를 거부할 수 있으며 동의 거부시 회원가입을 할 수 없습니다.
...
<script type="text/javascript">
	...
	btnSubmit.click(function(){
		...
		var natal_year = jQuery(".natal_year").val();
		var natal_month = jQuery(".natal_month").val();
		var natal_day = jQuery(".natal_day").val();
		if (natal_year == "" || natal_year == null || natal_month == "" || natal_month == null || natal_day == "" || natal_day == null){
			alert("출산예정일을 입력해주세요.");
			return false;
		}
