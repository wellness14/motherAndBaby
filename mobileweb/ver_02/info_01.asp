...
<div id="wrap">
	<header id="gnb" class="">
		<div class="topbar">
			...
			<h2 class="top_title">
				<span style="color:#ed587a;">상담</span><span style="color:#919194;">신청</span>
	...
	<div id="container" class="p10">
		...
		<table  border="0" align="center" cellpadding="0" cellspacing="0">
			<!-- <tr>
				<td colspan="2" style="padding-top:0px;"><img src="/mobileweb/html/images/sub03_subtitle01.jpg"  /><br/><br/></td>
			</tr>
			 -->
			<tr>
				<td colspan="2" bgcolor="#ffffff" style="padding-bottom:20px;">
					<img src="/mobileweb/html/images/text_0041.png"   />
					<table  border="0" align="center" cellpadding="0" cellspacing="10">
					<tr>
						<td style="padding-left:6px;" class="consult-label">
<!-- 							<img src="/mobileweb/html/images/text_0011.png"  /> -->
							성명
						</td>
						<td width="200"><label>
					...
					<tr>
						<td style="padding-left:6px;" class="consult-label">
<!-- 							<img src="/mobileweb/html/images/text_0013.png" /> -->
							출산예정일
						</td>
						<td><label>
							<select name="Ybirth" class="textarea" style="height:35px;" valid="E|A=출산예정일을 선택해 주세요">
							...
							<label>
							<select name="Mbirth" class="textarea" style="height:35px;" valid="E|A=출산예정일을 선택해 주세요">
							...
							<label>
							<select name="Dbirth" class="textarea" style="height:35px;" valid="E|A=출산예정일을 선택해 주세요">
					...
					<tr style="display:none">
						<td style="padding-left:6px;"><img src="/mobileweb/html/images/text_0014.png" /></td>
						<td>
							<label>
							...
							-
							<input type="text" name="phone_2" class="textarea" size="4" maxlength="4"/>
							-
							<input type="text" name="phone_3" class="textarea" size="4" maxlength="4"/>
						</td>
					</tr>	  	  	    	  
					<tr>
						<td style="padding-left:6px;" class="consult-label">
<!-- 							<img src="/mobileweb/html/images/text_0015.png" /> -->
							핸드폰번호
						</td>
						<td>
							<label>
					...
					<tr>
						<td style="padding-left:6px;" id="mbt5"><img src="/mobileweb/html/images/text_0016.png" /></td>
						<td>
                          ...
                          <a onclick="fncOpenZip_layer()" style="cursor:pointer;"><img src="/mobileweb/html/images/bt_0004.jpg" border="0" /></a>
                    ...
                    <tr>
						<td style="padding-left:6px;" class="consult-label">
<!-- 							<img src="/mobileweb/html/images/text_0085.png" /> -->
							지점선택
						</td>
						<td>
					...
					<tr>
						<td style="padding-left:6px;">
							<!-- <img src="/mobileweb/html/images/text_0052.png" /> -->
							상담내용
						</td>
						<td><label>
							<textarea name="textarea" class="textarea8" valid="E|A=상담내용을 입력해 주세요" style="margin-top: 6px;"></textarea>
						</label></td>
					</tr>	  	  
                    </table>
			...
			<tr>
				<td colspan="2" bgcolor="#ffffff" style="padding-bottom:20px;"><img src="/mobileweb/html/images/text_0042.png"   />
					<table  border="0" align="center" cellpadding="0" cellspacing="10">	  
					<!-- <tr>
						<td style="padding-left:6px;"><img src="/mobileweb/html/images/text_0043.png" /></td>
						<td width="229"> 
							<label>
					...
					<!-- <tr>
						<td style="padding-left:6px;">
							<img src="/mobileweb/html/images/text_0044.png" />
						</td>
						<td height="40">
							<label>
					...
					<tr>
						<td style="padding-left:6px;" class="consult-label">
							이용형태
							<!-- <img src="/mobileweb/html/images/text_0045.png" /> -->
						</td>
						<td height="40">
							<label>
					...
					<!-- <tr>
						<td style="padding-left:6px;" width="101"><img src="/mobileweb/html/images/text_0046.png" /></td>
						<td width="229"><label>
					...
					<!-- <tr>
						<td style="padding-left:6px;" width="101"><img src="/mobileweb/html/images/text_0047.png" /></td>
						<td width="229"><label>
					...
					<tr>
						<td style="padding-left:6px;" class="consult-label">
							조리원이용
							<!-- <img src="/mobileweb/html/images/text_0048.png" /> -->
						</td>
						<td height="40"><label>
					...
					<!-- <tr>
						<td style="padding-left:6px;"><img src="/mobileweb/html/images/text_0049.png" /></td>
						<td height="40"><label>
					...
					<tr>
						<td style="padding-left:6px;"><img src="/mobileweb/html/images/text_0050.png" /></td>
						<td height="40"><label>
					...
					<tr>
						<td style="padding-left:6px;"><img src="/mobileweb/html/images/text_0051.png" /></td>
						<td height="40"><label>
					...
					<tr>
						<td style="padding-left:6px;"><img src="/mobileweb/html/images/text_0052.png" /></td>
						<td><label>
...
3. 본 약관에 없는 사항은 관습 또는 일반적인 상 관례에 준합니다.
					...
					<input type="checkbox" name="check4" value="Y" valid="E|A=이용약관을 선택해 주세요"/> 위의 약관에 동의합니다.
				</td>
			</tr>
			<tr>
				<td colspan="2">
...
4. 경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)
					...
					<input type="checkbox" name="check5" value="Y" valid="E|A=개인정보 취급방침을 선택해 주세요"/> 위의 개인정보 수집 및 이용에 동의합니다.
				</td>
			</tr>
            <tr align="center">
				<td colspan="2" style="padding-top:30px; padding-bottom:25px;">
					<img src="/mobileweb/html/images/bt_0014.jpg" border="0" id="btnSubmit" style="cursor:pointer;"/>
					<img src="/mobileweb/html/images/bt_0002.jpg" border="0" onClick="location.reload();" style="cursor:pointer;"/>
				</td>	
			</tr>
		</table>
		</form>
	...
	<style type="text/css">
     #AreaZip{
	  width:400px; height:500px; background:#ffffff; color:#fff; 
	  position:fixed; top:60px; left:0px; text-align:left; 
