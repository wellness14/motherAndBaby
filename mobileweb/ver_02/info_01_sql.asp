...
'-----------------------------------------------------------------------------
'	데이터 확인
	'If Mbirth <> "" And Dbirth <> "" Then
	'	birth = Ybirth & fncSetNumber(Mbirth) & fncSetNumber(Dbirth)
	'End If

	If Mbirth <> "" And Dbirth <> "" Then
		childbirth = Ybirth & fncSetNumber(Mbirth) & fncSetNumber(Dbirth)
	End If
