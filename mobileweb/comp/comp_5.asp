        ...
        <tr>
			...
			<tr>
				...
				<tr>
			        ...
			        <td width="60"><a href="./comp_5.asp"><img src="/comp/mapnavi/img/bt_0127_on.jpg" class="main_tab" style="cursor:pointer;"width="60" height="16" border="0" /></td>
...
<br/>
				 ...
				 <table align="center" class="tb_style01">
						<tr style="width:150px;height:30px; border:1px solid #d3d3d3; background:#f1f1f1;">
								<td width="360"><span style="margin-left:1px;">구미 지사(구미)</span></td> <td width="90"> <span style="margin-left:2px;cursor:pointer;" class="detail"> 자세히보기 </span>
					  ...
					  <div>
						<table align="center" class="tb_style01">
						   ...
						   <tr style="width:150px;height:30px; border:1px solid #d3d3d3;">
								...
								<td>054-604-3577&nbsp;&nbsp;<span style="background-image: url(/comp/mapnavi/img/iphoneappph2.PNG);width:15px;height:15px;"><a href="tel:054-604-3577">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
				 ...
				 <table align="center" class="tb_style02">
						<tr style="width:150px;height:30px; border:1px solid #d3d3d3; background:#f1f1f1;">
								<td width="360"><span style="margin-left:1px;">김천 지사(김천)</span></td> <td width="90"> <span style="margin-left:2px;cursor:pointer;" class="detail_2"> 자세히보기 </span>
