        ...
        <tr>
			...
			<tr>
				...
				<tr>
			        ...
			        <td width="60"><a href="./comp_4.asp"><img src="/comp/mapnavi/img/bt_0126_on.jpg" class="main_tab" style="cursor:pointer;" width="60" height="16" border="0" /></td>
...
<br/>
				 ...
				 <table align="center" class="tb_style01">
						<tr style="width:150px;height:30px; border:1px solid #d3d3d3; background:#f1f1f1;">
								<td width="360"><span style="margin-left:1px;">대전 지역(유성구)</span></td> <td width="90"> <span style="margin-left:2px;cursor:pointer;" class="detail"> 자세히보기 </span>
					  ...
					  <div>
						<table align="center" class="tb_style01">
						   <tr style="width:150px;height:30px; border:1px solid #d3d3d3;">
								<td>주소</td> 
								<td width="210"> 대전광역시 서구 둔산동 1015번지 대원빌딩 4층 </td>
						   ...
						   <tr style="width:150px;height:30px; border:1px solid #d3d3d3;">
								...
								<td>042-471-3579&nbsp;&nbsp;<span style="background-image: url(/comp/mapnavi/img/iphoneappph2.PNG);width:15px;height:15px;"><a href="tel:042-471-3579">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
				 ...
				 <table align="center" class="tb_style02">
						<tr style="width:150px;height:30px; border:1px solid #d3d3d3; background:#f1f1f1;">
								<td width="360"><span style="margin-left:1px;">대전 지역(대덕구)</span></td> <td width="90"> <span style="margin-left:2px;cursor:pointer;" class="detail_2"> 자세히보기 </span>
				 ...
				 <table align="center" class="tb_style03">
						<tr style="width:150px;height:30px; border:1px solid #d3d3d3; background:#f1f1f1;">
								<td width="360"><span style="margin-left:1px;">대전 지역(서구)</span></td> <td width="90"> <span style="margin-left:2px;cursor:pointer;" class="detail_3"> 자세히보기 </span>
				 ...
				 <table align="center" class="tb_style01">
						<tr style="width:150px;height:30px; border:1px solid #d3d3d3; background:#f1f1f1;">
								<td width="360"><span style="margin-left:1px;">대전 지역(중구)</span></td> <td width="90"> <span style="margin-left:2px;cursor:pointer;" class="detail_4"> 자세히보기 </span>
				 ...
				 <table align="center" class="tb_style01">
						<tr style="width:150px;height:30px; border:1px solid #d3d3d3; background:#f1f1f1;">
								<td width="360"><span style="margin-left:1px;">대전 지역(동구)</span></td> <td width="90"> <span style="margin-left:2px;cursor:pointer;" class="detail_5"> 자세히보기 </span>
