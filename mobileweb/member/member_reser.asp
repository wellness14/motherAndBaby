...
<%
	...
	If uId <> "" Then 
		...
		If Not Rs.EOF Then
			...
			End If 
		Else 
			response.Write "<script type='text/javascript'>alert('예약 내용이 존재하지 않습니다.');location.href='/mobileweb/main/';</script>"
			response.End 
		End If 
		Call RSClose(Rs)
	Else 
		response.Write "<script type='text/javascript'>alert('로그인 후 이용 가능합니다.');location.href='/mobileweb/member/login.asp';</script>"
		response.End 
	End If 
%>
         <div id="mcontainer">
			...
			<tr>
				<td width="360" style="padding-top:13px; padding-bottom:20px;"><img src="/mobileweb/html/images/text_0071.jpg" width="150"/><spacer type="block"></td>
			</tr>  
			<tr>
			...
			<tr>
				<td width="360" style="padding-top:40px; padding-bottom:20px;"><img src="/mobileweb/html/images/text_0072.jpg" width="150"/><spacer type="block"></td>
			</tr>
			</table>
