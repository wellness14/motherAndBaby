...
<% If Left(menuCode1,1) = "1" And menuCode2 = "A" Then %>
<script type="text/javascript" src="/mobileweb/common/js/superslide.2.1.js"></script>
<script type="text/javascript" src="/mobileweb/common/js/jquery.bxslider.min.js"></script>
 
<link type="text/css" rel="stylesheet" href="/mobileweb/common/css/jquery.bxslider.css"/><% End If %>
