	...
	<div id="wrap">
        ...
        <div class="slider_panel">
			<ul class="bxslider">
				...
				<li><a target="_blank" href="/mobileweb/board/board_01_view.asp?idx=41&brd_id=EVENT&sec_flg=Y&mOne=4&mTwo=5"><img src="/mobileweb/html/images/iwing_event_360x226.jpg" alt="" class="slider_image"/></a></li>
			</ul>
        </div>
...
<script>
        ...
        $(document).ready(function () {
			...
			jQuery ('.bxslider').bxSlider({
				  ...
				  auto: true,
				  autoControls: true,
				  onSlideBefore: function() {sliderDot()},
			  });
        });
		...
		function sliderDot() {
			...
			if (slide > $('.control_button').length - 1) {
				slide = 0;
			}

			$('.control_button[data-index=' + slide + ']').addClass('active');
			$('.control_button[data-index!=' + slide + ']').removeClass('active');
		}
