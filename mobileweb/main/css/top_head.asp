...
<% If Left(menuCode1,1) = "1" And menuCode2 = "A" Then %><link type="text/css" rel="stylesheet" href="/mobileweb/main/css/care_program_01.css"/><% End If %>
<% If Left(menuCode1,1) = "1" And menuCode2 = "B" Then %><link type="text/css" rel="stylesheet" href="/mobileweb/main/css/care_program_02.css"><% End If %>
<% If Left(menuCode1,1) = "2" Or  Left(menuCode1,1) = "3" Or Left(menuCode1,1) = "4" Or Left(menuCode1,1) = "5" Then %><link type="text/css" rel="stylesheet" href="/mobileweb/main/css/care_program_03.css"><% End If %>
