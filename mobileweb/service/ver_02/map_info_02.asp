...
<%
				...
				area_detail3(1) = "국민은행 222001-04-158524<br/>예금주 임미영(마더앤베이비)"
				...
				area(4) = "구리지사"
				area_addr(4) = "경기도 구리시 건원대로 34번길 27 세신인창종합상가 716호"
				area_tel(4) = "031-566-3579"
				area_time(4) = "AM 09:00 ~ PM 06:00"
				area_detail2(4) = " 031-551-3579"
				...
				area_detail3(5) = "국민은행 222001-04-158524<br/>예금주 임미영(마더앤베이비)"
				...
				area(7) = "남양주지사"
				area_addr(7) = "경기도 구리시 건원대로 34번길 27 세신인창종합상가 716호"
				area_tel(7) = "031-566-3579"
				area_time(7) = "AM 09:00 ~ PM 06:00"
				area_detail2(7) = " 031-551-3579"
				area_detail3(7) = "우리은행 1005-603-174176<br/>예금주 김용원 (마더앤베이비 구리·남양주)"

				area(8) = "동두천지사"
				area_addr(8) = "경기도 의정부시 금오동 470-1 파크플라자 705호"
				area_tel(8) = "031-853-3570 "
				...
				area_detail3(11) = "국민은행 422001-04-184529<br/>예금주 황수연(마더앤베이비수원)"
				...
				area_detail3(14) = "국민은행 222001-04-158524<br/>예금주 임미영(마더앤베이비)"

				area(15) = "양주지역"
				area_addr(15) = "경기도 의정부시 금오동 470-1 파크플라자 705호"
				area_tel(15) = "031-853-3570 "
				...
				area_detail3(18) = "국민은행 222001-04-158524<br/>예금주 임미영(마더앤베이비)"

				area(19) = "의정부지점"
				area_addr(19) = "경기도 의정부시 금오동 470-1 파크플라자 705호"
				area_tel(19) = "031-853-3570 "
				...
				area(20) = "연천지점"
				area_addr(20) = "경기도 의정부시 금오동 470-1 파크플라자 705호"
				area_tel(20) = "031-853-3570 "
				...
				area(22) = "포천지점"
				area_addr(22) = "경기도 의정부시 금오동 470-1 파크플라자 705호"
				area_tel(22) = "031-853-3570 "
