...
<div id="wrap">
	<header id="gnb" class="">
		<div class="topbar">
			...
			<h2 class="top_title">
				<span style="color:#ed587a;">1:1문의</span><span style="color:#919194;">하기</span>
	...
	<div id="container" class="p10">
		...
		<!-- <table border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td style="padding-top:0px;"><img src="/mobileweb/html/images/sub04_subtitle03.jpg" /></td>
			</tr>
		</table> -->
		...
		<table class="table" style="font-size:10pt;">
			...
			<thead>
				...
				<th style="padding:0px; padding-top:3px; padding-bottom:3px;">처리상태</th>
			</thead>
			<tbody>
			<%
			...
			%>
				<tr <% If ba_dph <> "1" Then %> class="active" <% End If %>>
					...
					<td style="padding:0px; padding-left:3px; padding-top:3px; padding-bottom:3px;" align="left">
						...
						<%If sec_flg <> "N" Then%>&nbsp;<img src="/image/img_0006.png" style="width:22px;" align="absmiddle" /><%End If%>
					</td>
					...
					<td style="padding:0px; padding-top:3px; padding-bottom:3px;"><%=re_nm%></td>
				</tr>
			<%
					Next
				End If
