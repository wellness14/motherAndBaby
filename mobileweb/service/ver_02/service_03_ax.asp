...
'				response.End 
				...
				If Not Rs.EOF Then 
					...
					End If 
					Call RSClose(Rs1)
					strContent = "<td bgcolor='#f6f6f6' style='padding-left:12px; padding-right-12px;'></td>"
					strContent = strContent & " <td bgcolor='#f6f6f6' style='font-size:11px; text-align:center; color:#000000'><div align='center'><br/>산모님의 건강한 산후조리를 마더앤베이비가 함께하겠습니다.<br/><br/>"
					strContent = strContent & " 산모님께는 <span style='color:#ff015a; font-weight:bold;'>"& service &"</span><br/>프로그램이 적합하시며,"
					...
					strContent = strContent & " <span style='color:#ff015a; font-weight:bold;'>"& service_nm &"</span>를 권해드립니다.<br/><br/></div></td> "
...
'				response.End 
				...
				If Not Rs.EOF Then 
					...
					strContent = " <td bgcolor='#f6f6f6'><img src='/mobileweb/html/images/img_0012.jpg' width='72' height='68' /></td>"
					strContent = strContent & " <td bgcolor='#f6f6f6' style='font-size:11px; color:#000000; font-weight:bold;'><div align='center'>산모님의 산후조리서비스 최종적인 예상비용은 "
	...
	function Init(e) {
		switch(e) {
			...
			case(4) :	
				...
				//parent.location.href = "/mobileweb/member/member_service.asp"
				parent.location.href = "service_03.asp"
			break;
		}
	}
