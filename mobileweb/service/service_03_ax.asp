...
'				response.End 
				...
				If Not Rs.EOF Then 
					...
					End If 
					Call RSClose(Rs1)
					strContent = "<td width='360' bgcolor='#f6f6f6' style='padding-left:12px; padding-right-12px;></td>"
...
'				response.End 
				...
				If Not Rs.EOF Then 
					...
					strContent = strContent & " <td width='704' bgcolor='#f6f6f6' style='font-size:11px; color:#000000; font-weight:bold;'><div align='center'>산모님의 산후조리서비스 최종적인 예상비용은 "
