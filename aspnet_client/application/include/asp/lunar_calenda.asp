...
Dim LTBLSTR, LTBL, LDAYSTR, LDAY, DT, YUKSTR, YUK, GAPSTR, GAP, DDISTR, DDI, WEEKSTR, WEEK, M1, gf_Is_Yun
Dim I, J 
Dim TD1, K11, TD2, TD, TD0
Dim rYear, JCOUNT, M2
Dim GF_YUN, k1, k2, syuk, sgap, sddi, GF_SOL2LUN, ex_yymmdd
...
gf_lun2sol = exyear &"-"& right("0" & exmonth,2) &"-"& right("0" & exday,2) 
'response.write ex_yymmdd 

'response.write exyuk & exddi & exyear & exmonth & exday
end function


'Call gf_lun2sol("1974","08","23","0") 
