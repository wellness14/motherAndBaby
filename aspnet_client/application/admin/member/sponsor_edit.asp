...
<body>
    ...
    <h3 class="tit_pulisher">광고주 기본 정보 </h3>
		...
		<input type="hidden" name="sMode" value="sponsor_edit">
			...
			<fieldset>
				...
				<table class="tbl_regist">
					...
					<tr>
						...
						<td colspan=3>
							<div class="inner_cell">
									<input type="radio" id="SponsorType" class="inp_comm" name="SponsorType" value="C" <% If SponsorType = "C" then%>checked<%End if%>>
									<label for="flagMaster">법인사업자</label>
									<input type="radio" id="SponsorType" class="inp_comm" name="SponsorType" value="I" <% If SponsorType = "I" then%>checked<%End if%>>
									<label for="flagSysop">개인사업자</label>
									<input type="radio" id="SponsorType" class="inp_comm" name="SponsorType" value="P" <% If SponsorType = "P" then%>checked<%End if%>>
					...
					<tr>
						...
						<td colspan=3>
							<div class="inner_cell">
								<input type="text" name="CName" id="inpName" class="tf_comm" value="<%=ComName%>" maxlength="50">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="inner_cell">
								<input type="text" name="CNumber" id="inpName" class="tf_comm" value="<%=CNumber%>" maxlength="20">
						...
						<td>
							<div class="inner_cell">
								<input type="text" name="CNumber2" id="inpName" class="tf_comm" value="<%=CNumber2%>" maxlength="20">
								<span class="txt_num" id="text_size">("-"제외후 입력)</span>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td colspan=3>
							<div class="inner_cell">
								<input type="text" name="Ceo" id="inpName" class="tf_comm_s2"  value="<%=Ceo%>" maxlength="20">
							</div>
						</td>
					</tr>
                    <tr>
						...
						<td>
							<div class="inner_cell">
								<input type="text" name="Ckind" id="inpName" class="tf_comm" value="<%=Ckind%>" maxlength="50">
							</div>
						</td>
						<th scope="row"><label for="inpName" class="lab_comm tit_subject">종목</label></th>
						<td>
							<div class="inner_cell">
								<input type="text" name="Cgoods" id="inpName" class="tf_comm" value="<%=Cgoods%>" maxlength="50">
							</div>
						</td>
					</tr>
                    <tr>
						...
						<td colspan=3>
							<div class="inner_cell">
								<input type="text" name="zip1" id="inpName" class="tf_comm_s1" value="<%=zip1%>" maxlength="3">
								<input type="text" name="zip2" id="inpName" class="tf_comm_s1" value="<%=zip2%>" maxlength="3">
								<input type="text" name="address1" id="inpName" class="tf_comm" value="<%=address1%>">
                                <input type="text" name="address2" id="inpName" class="tf_comm" value="<%=address2%>">
					...
					<tr>
						...
						<td colspan=3>
							<div class="inner_cell">
								<input type="text" name="Cemail" id="inpName" class="tf_comm" value="<%=CEmail%>" maxlength="50">
					...
					<tr>
						...
						<td>
							<div class="inner_cell">
								<input type="text" name="Ctel" id="inpName" class="tf_comm" value="<%=CTel%>" maxlength="50">
								<span class="txt_num" id="text_size">("-"제외후 입력)</span>
							</div>
						</td>
						...
						<td>
							<div class="inner_cell">
								<input type="text" name="Cfax" id="inpName" class="tf_comm" value="<%=CFax%>" maxlength="50">
								<span class="txt_num" id="text_size">("-"제외후 입력)</span>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td colspan=3>
							<div class="inner_cell">
								<input type="file" name="filename" class="file_attachment"> 첨부파일다운로드
				...
				<div class="wrap_btn">
				   <span class="bundle_btn">
					   ...
					   <a href="sponsor_view.asp?sponCode=<%=sponCode%>" class="btn_cancel">취소</a>
				   </span>
				</div>
				</div>
			</fieldset>
