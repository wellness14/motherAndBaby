...
'			response.End 
		...
		Case "upd" : 
			...
			strSql = strSql & "			BA_LOCAL='"& class_value_1 &"', BA_LOCAL='"& title_value_1 &"', BA_EMAIL='"& email &"', BA_FILE_NM='"& fileNm &"', BA_FILE_PATH='"& filePath &"', BA_UPD_DT = GETDATE() "
