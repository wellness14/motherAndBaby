...
<body>
	...
	<tr>
		...
		<td width="850" valign="top">
			...
			<table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td width="155"><img src="/image/bt_0007_on.jpg" class="main_tab"  style="cursor:pointer; cursor:hand; width:155px; height:40px;" /></td>
				<td width="154"><img src="/image/bt_0008_off.jpg" class="main_tab" style="cursor:pointer; cursor:hand; width:154px; height:40px; border:0;" /></td>
				<td width="154"><img src="/image/bt_0009_off.jpg" class="main_tab" style="cursor:pointer; cursor:hand; width:154px; height:40px; border:0;" /></td>
				<td width="307"><img src="/image/bt_0010_off.jpg" class="main_tab" style="cursor:pointer; cursor:hand; width:152px; height:40px; border:0;" /></td>
			</tr>
			<tr>
...
<map name="faq" id="faq">
<area shape="rect" coords="2,108,230,149" href="http://mothernbaby.co.kr/board/board_03.asp?mOne=4&mTwo=3" /></map>
</body>
