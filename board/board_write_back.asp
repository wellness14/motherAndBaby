			...
			<input type="hidden" name="mode" value="ins">
				<td bgcolor="#f6f6f6" style="padding-top:20px; padding-bottom:20px;">
					...
					<tr>
						...
						<td><input type="text" name="pw" class="textarea" size="35" valid="E|N|M=5|T=비밀번호|A=비밀번호를 입력해 주세요"/></td>
					</tr>
					<% End If %>
					<tr>
						<td><img src="/image/text_0017.jpg" width="74" height="20" /></td>
						<td><input type="text" name="email" class="textarea" size="35" valid="E|M=20|A=이메일을 입력해 주세요"/></td>
					</tr>	
					<tr>
						<td><img src="/image/text_0085.png" width="74" height="20" /></td>
						<td>
							<select name="local" onchange="fncSetPart(this.value);" valid="E|A=지점을 선택해 주세요">
							...
							<select id="part" name="part" valid="E|A=지점을 선택해 주세요">
					...
					<tr>
						...
						<td><textarea name="content" class="textarea2" valid="E|M=500|A=내용을 입력해 주세요"></textarea></td>
					</tr>
					<!--tr>
