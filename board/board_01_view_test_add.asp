...
%>
				...
				<table width="650" border="0" align="center" cellpadding="0" cellspacing="10" style="margin:0 auto; width:740px;height:210px;background-color:#ebebeb; border-top:2px solid #ccc;">
					...
					<tr>
						<td>비밀번호</td>
						<td><input type="password" name="pw" class="textarea" size="35" value="<%=comment_pw%>" valid="E|N|M=10|T=비밀번호|A=비밀번호를 입력해 주세요"/></td>
					</tr>
					<tr>
						<td>URL입력</td>
						<td><textarea name="content"class="textarea7" value="<%=comment_comment%>" valid="E|M=3000|A=내용을 입력해 주세요"><%=comment_comment%></textarea></td>
					</tr>
