...
<body>
	<div id="header">
	<div id="navi_tit_name"><span  class="position_navi">회원관리 > 일반회원 > 휴면회원</span>
	</div>
...
<div id="search">
		 ...
		 <ul class="search_01">
			...
			<li class="open_day">
				가입일 <input type="radio" value="join" name="join_d">
				접속일 <input type="radio" value="contact" name="contact_d">
				생일 <input type="radio" value="birth" name="birth_d">
		...
		<ul class="search_03">
			...
			<li class="f_male ">
				전체 <input type="radio" value="all" name="alld">
				남자 <input type="radio" value="male" name="male ">
				여자 <input type="radio" value="female" name="female">
				<input type="text" size="10" value="달력"> ~ <input type="text" size="10" value="달력">
			</li>
...
<table width="770"  align="center" border="1" cellspacing="2" cellpadding="1"id="content">
	...
	<tr>
		...
		<th class="content_tit">가입일</th>
		<th class="content_tit">휴면전환일</th>
		<th class="content_tit">전환방법</th>
