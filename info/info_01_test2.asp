				...
				<td colspan="2" bgcolor="#f6f6f6" style="padding-bottom:20px;"><img src="/image/text_0042.jpg" width="770" height="50" />
					...
					<tr>
						...
						<td height="40"><label>
							...
							(<input type="radio" name="radio3_1" value="1주"/>1주
							<input type="radio" name="radio3_1" value="2주"/>2주
							<input type="radio" name="radio3_1" value="3주"/>3주
							<input type="radio" name="radio3_1" value="4주이상"/>4주이상)
