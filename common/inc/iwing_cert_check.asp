...
strTEMP = FnGET_INFO_URL("http://iwing.mflare.co.kr:8080/iwingEvent/controller?do=API_USER_ACTION&proc_type=confirmUser&user_id="&mem_id&"&pwd="&pwd&"&pn_mem_id=mBaby")
