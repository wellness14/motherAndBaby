...
<%
	  ...
	  mo_helper_name1		= Trim(fncRequest("mo_helper_name1"))
...
'	strWhere = "    "
  ...
  'select count(1) FROM MO_HELPER where MD_HELPER_NAME like '%강경%'
...
'	strSql = strSql & strWhere
	...
	strSql = strSql & "  ) T1 "
	strSql = strSql & " WHERE MD_HELPER_NAME like '%"& mo_helper_name1 &"%' and "
...
<script type="text/javascript">
	...
	function fncInputAddr(postcd1,postcd2,hp_Seq){
		opener.InputName_Comment(postcd1,postcd2,hp_Seq);
		self.close();
	}
