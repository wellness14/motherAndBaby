...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/common/inc/Edit_Uploader.asp" method="post" enctype="multipart/form-data"> <!-- 수정한곳 onsubmit 빼버림 -->
	    <input type="hidden" name="callHost" value="<%=fncRequestVariables("HTTP_HOST")%>">
        <div id="pop_content2">
			<input type="file" class="upload" id="uploadInputBox" name="uploadInputBox">	<!-- 수정한곳 name명만 수정 -->
            <p class="dsc" id="info"><strong>2MB</strong>이하의 이미지 파일만 등록할 수 있습니다.<br>(JPG, GIF, BMP)</p>
        </div>
		</form>
        <!-- //content -->
    </div>
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="/common/SmartEditor2/img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="/common/SmartEditor2/img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
<script type ="text/javascript">
    var fileUrl = '/common/inc/Edit_Uploader.asp'; //파일서버 경로명
</script>    
