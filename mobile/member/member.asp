...
<body>
	<div id="wrap">
        ...
        <!----------------------------------------- 본문 ----------------------------------------->
         <div id="mcontainer_text">
        <td width="360px" valign="top"><table width="360px" height="300px" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td colspan="2" style="padding-top:0px;"><img src="/mobile/html/images/sub62.jpg" border="0" width="360"/></td>
			</tr>
			...
			<tr>
				<td width="180" style="padding-top:30px; padding-bottom:40px; padding-left:14px;"><img src="/mobile/html/images/text_0005.jpg" width="78" height="18" /><br /><br />
					<textarea class="textarea3">마더앤베이비 서비스 이용약관
...
3. 본 약관에 없는 사항은 관습 또는 일반적인 상 관례에 준합니다.</textarea>
					<br/><br/><br/><p id="ccc">
					<label>
				...
				<td width="180" style="padding-top:30px; padding-bottom:40px;"><img src="/mobile/html/images/text_0006.jpg" width="137" height="18" /><br /><br />
					<textarea class="textarea3">마더앤베이비 개인정보취급방법
...
4. 경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)
					...
					<label>
						...
						위의 개인정보 수집 및 이용에 동의합니다. </p>
				</td>
			</tr>
			<tr>
				<td colspan="2" bgcolor="#f6f6f6" style="padding-bottom:20px;"><img src="/mobile/html/images/text_0007.jpg" width="360" height="49" />
					<table width="360"  border="0" align="center" cellpadding="0" cellspacing="10">
					<tr>
						<td class="mjoin" id="joinbtn1" width="87"><img src="/mobile/html/images/text_0008.jpg" width="81" /></td>
						<td width="263"><label>
							<input type="text" id="mem_id" name="mem_id" class="textarea" size="22" style="ime-mode:disabled;" valid="E|M=10|T=아이디|A=아이디를 입력해 주세요"/>
						</label>
					    <img src="/mobile/html/images/bt_0027.jpg" border="0" align="absmiddle" id="btnIdCheck" style="cursor:pointer;"/>
						<img src="/mobile/html/images/text_0021.jpg" width="230"  align="absmiddle" id="ttt"/>
					</td>
					</tr>
					<tr>
						<td class="mjoin" id="joinbtn2"><img src="/mobile/html/images/text_0009.jpg" width="81" /></td>
						<td><label>
							<input type="password" id="mem_pw" name="mem_pw" class="textarea" size="26" style="ime-mode:disabled;"/>
						</label></td>
					</tr>
					<tr>
						<td class="mjoin" id="joinbtn3"><img src="/mobile/html/images/text_0010.jpg" width="81" /></td>
						<td><label>
							<input type="password" id="mem_pw_check" name="mem_pw_check" class="textarea" size="26" style="ime-mode:disabled;"/>
						</label></td>
					</tr>
					<tr>
						<td class="mjoin" id="joinbtn4"><img src="/mobile/html/images/text_0011.jpg" width="81" /></td>
						<td><label>
							<input type="text" name="mem_nm" class="textarea" size="22"/>
						</label></td>
					</tr>	
					<tr>
						<td class="mjoin" id="joinbtn5"><img src="/mobile/html/images/text_0012.jpg" width="81" /></td>
						<td height="40"><label>
							<input type="radio" name="radio1" value="2"/>여자&nbsp;&nbsp;
							<input type="radio" name="radio1" value="1" />남자
						</label></td>
					</tr>	  
					<tr>
						<td class="mjoin" id="joinbtn6"><img src="/mobile/html/images/text_0013.jpg" width="81" /></td>
						<td><label>
							<select name="Ybirth" class="textarea" style="height:35px;">
								<option value="">년</option>
							<% For num=Year(Date()) To Year(DateAdd("yyyy",-50,Date())) Step -1 %>
								<option value="<%=num%>"><%=num%></option>
							<% Next %>
							</select>
							<select name="Mbirth" class="textarea" style="height:35px;">
								<option value="">월</option>
							<% For num=1 To 12 %>
								<option value="<%=num%>"><%=num%>월</option>
							<% Next %>
							</select>
							<select name="Dbirth" class="textarea" style="height:35px;">
					...
					<tr>
						<td class="mjoin" id="joinbtn7"><img src="/mobile/html/images/text_0014.jpg" width="81" /></td>
						<td><label>
					...
					<tr>
						<td class="mjoin" id="joinbtn8"><img src="/mobile/html/images/text_0015.jpg" width="81" /></td>
						<td><label>
							...
							-
							<input type="text" id="hp_2" name="hp_2" class="textarea" size="5" maxlength="4"/>
							-
							<input type="text" id="hp_3" name="hp_3" class="textarea" size="5" maxlength="4"/>&nbsp;&nbsp;<br/><img src="/mobile/html/images/bt_0028.jpg" border="0" align="absmiddle" id="btnSms" style="cursor:pointer;"/><br/>
					...
					<tr>
						...
						<td >
						    ...
						    <img src="/mobile/html/images/bt_0029.jpg" border="0" align="absmiddle" id="btnSmsCheck" style="cursor:pointer;"/>
						</td>
					</tr>
                    <tr>
						<td>&nbsp;</td>
					...
					<tr>
						<td class="mjoin" id="joinbtn9"><img src="/mobile/html/images/text_0016.jpg" width="81" /></td>
						<td>
							<input type="text" id="post_1" name="post_1" class="textarea" size="5" maxlength="3" readonly/>
							-
							<input type="text" id="post_2" name="post_2" class="textarea" size="5" maxlength="3" readonly/>
							<a onclick="fncOpenZip_layer()" style="cursor:pointer;"><img src="/mobile/html/images/bt_0004.jpg" width="107" height="28" border="0" /></a>
					...
					<tr>
						<td>&nbsp;</td>
						<td><label>
							<input type="text" id="addr_1" name="addr_1" class="textarea" size="28" readonly/>
						</label></td>
					</tr>	
					<tr>
						<td>&nbsp;</td>
						<td><label>
							<input type="text" name="addr_2" class="textarea" size="28"/>&nbsp;&nbsp;
						</label></td>
					</tr>
					<tr>
						<td class="mjoin" id="joinbtn10"><img src="/mobile/html/images/text_0017.jpg" width="81" /></td>
						<td><label>
							<input type="text" name="email" class="textarea" size="28"/>&nbsp;&nbsp;<br/>
							<br/><input type="checkbox" name="check4" value="Y" />이메일 수신동의 
						</label></td>
					</tr>
					</table>
				</td>	
			...
			<tr>
				<td colspan="2" bgcolor="#f6f6f6" style="padding-bottom:20px;"><img src="/mobile/html/images/text_0022.jpg" width="360" height="50" />
					<table width="360" border="0" align="center" cellpadding="0" cellspacing="10">	  
					<tr>
						<td class="mjoin2" width="87"><img src="/mobile/html/images/text_0085.png" width="63"/></td>
						<td>
					...
					<tr>
						<td class="mjoin2" width="87"><img src="/mobile/html/images/text_0018.jpg" width="71" /></td>
						<td width="263"><label>
					...
					<tr>
						<td class="mjoin2"><img src="/mobile/html/images/text_0019.jpg" width="71" /></td>
						<td height="40"><label>
					...
					<tr>
						<td class="mjoin2"><img src="/mobile/html/images/text_0020.jpg" width="71" /></td>
						<td height="40">
						<label>
			...
			<tr>
				<td colspan="2" style="padding-top:30px; padding-bottom:50px;">
					<div align="center" id="btn11">
						<div class="btn00"><img src="/mobile/html/images/bt_0003.jpg" width="110" border="0" id="btnSubmit" style="cursor:pointer;"/></div>
...
<form id="soFrm" name="soFrm" target="ifrm" method="post" action="/mobile/common/inc/sms_send.asp">
...
<script type="text/javascript">
	...
	btnSmsCheck.click(function(){
		...
		if (cert_num == ""){
			...
			jQuery.post("/mobile/common/inc/sms_check.asp",{"cert_num":cert_num,"hp":hp},function(data,testStatus){
				switch(data) {
					case("1") :
						alert('인증번호를 입력해 주세요');
					break;
	...
	btnIdCheck.click(function(){
		...
		jQuery.post("/mobile/common/inc/check_id_ax.asp",{"mem_id":id},function(data,testStatus){
			switch(data) {
				case("1") :
	...
	function fncOpenZip(){
		window.open("/mobile/common/inc/pop_zipcode.asp","pop_zipcode","width=500px, height=460px");
	}
...
<script type="text/javascript" src="/mobile/common/js/ajax_common.js"></script>
<script type="text/javascript">
	function fncSetPart(val){
		fncAxListHtml("/mobile/common/inc/local_ax.asp?local="+val,"#part");
	}
</script>
</html>