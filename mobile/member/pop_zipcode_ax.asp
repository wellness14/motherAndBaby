...
%>
	...
	<tr>
		<td height="50" style="padding-top:20px; padding-left:20px;"><img src="/mobile/html/images/text_0029.jpg"  style="position:relative; top:1px; left:25px;"/></td>
	</tr>
	<tr>
		<td height="60" style="padding-left:10px;">
			<input type="text" name="SearchDong" id="SearchDong" class="textarea" size="30"/>&nbsp;
			<img src="/mobile/html/images/bt_0003.jpg" width="110" border="0" align="absmiddle" onclick="fncSearchPost();" style="position:relative; top:2px; left:115px;"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
			<td><a onClick="div1_closeLayer('AreaZip')" class="close" id="pb02"><img src="/mobile/html/images/bt_close.jpg" width="110" border="0" align="center" style="cursor:pointer;"/></a></td>
	</tr>
	</table>
...
<script type="text/javascript">
	function fncSearchPost(){
        ...
        fncAxListHtml("/mobile/member/pop_zipcode_ax_answer.asp?SearchDong="+document.getElementById("SearchDong").value,"#listpart");
