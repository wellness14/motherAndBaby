...
<body>
	<div id="wrap">
        ...
        <td width="360px" valign="top"><table width="360px"  border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td style="padding-top:0px;"><img src="/mobile/html/images/sub61.jpg" border="0" width="360" /></td>
			</tr>
				...
				<td style="padding-top:30px; padding-bottom:5px; padding-left:20px; padding-right:20px;"><table width="320" height="310"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f6f6f6">
					<tr>
						<td height="70" colspan="2" valign="top">
							<label><img src="/mobile/html/images/text_0023.jpg" width="230" height="50" /></label>
						</td>
					</tr>
					<form id="LoginForm" name="LoginForm" method="post">
					<tr>
						<td width="94px" height="45" style="padding-left:24px;"><img src="/mobile/html/images/text_0008.jpg" width="74" height="20" /></td>
						<td width="226"><label>
							<input type="text" id="loginid" name="loginid" maxlength="20" class="textarea" size="21" style="height:40px; ime-mode:disabled;"/>
						</label></td>
					</tr>
					<tr>
						<td height="45" style="padding-left:24px;"><img src="/mobile/html/images/text_0009.jpg" width="74" height="20" /></td>
						<td><label>
					...
					<tr>
						<td height="70" colspan="2"><div align="center"><a href="javascript:goLogin();"><img src="/mobile/html/images/bt_0005.jpg" width="150" height="40" border="0" /></a></div></td>
					</tr>	  
					</table>
				  <div align="center"><br /><img src="/mobile/html/images/text_0024.jpg" width="320" border="0" usemap="#id_pass" /></div>
				</td>	
</tr>
</table>
</td>
    ...
    <map name="id_pass" id="id_pass">
		<area shape="rect" coords="48,19,148,39" href="/mobile/member/member.asp" />
		<area shape="rect" coords="184,21,284,41" href="/mobile/member/member_find_info.asp" />
	</map>
