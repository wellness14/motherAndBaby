...
<%
	...
	If uId <> "" Then 
		...
		If Not Rs.EOF Then 
			arrList = Rs.getRows()
		Else 
			response.Write "<script type='text/javascript'>alert('회원정보가 올바르지 않습니다.');location.href='http://mothernbaby.co.kr/mobile/main';</script>"
			response.End 
		End If 
		Call RSClose(Rs)
	Else 
		response.Write "<script type='text/javascript'>alert('로그인 후 이용 가능합니다.');location.href='http://mothernbaby.co.kr/mobile/member/login.asp';</script>"
		response.End 
	End If 
...
%>
         <div id="mcontainer">
			...
			<tr>
				<td bgcolor="#f6f6f6" style="padding-bottom:20px;"><img src="/mobile/html/images/text_0007.jpg" width="360" height="49" />
					...
					<tr>
						<td class="mjoin"><img src="/mobile/html/images/text_0013.jpg" width="61"/></td>
					...
					<tr>
						<td class="mjoin"><img src="/mobile/html/images/text_0014.jpg" width="61" /></td>
						<td><label>
						<%
					...
					<tr>
						<td class="mjoin"><img src="/mobile/html/images/text_0015.jpg" width="61" /></td>
						<td><label>
						<%
				...
				<tr>
					<td class="mjoin"><img src="/mobile/html/images/text_0016.jpg" width="61" /></td>
					<td>
						...
						<!--&nbsp;&nbsp;<img src="/mobile/html/images/bt_0004.jpg" width="107" height="28" border="0" align="absmiddle" onclick="fncOpenZip();" style="cursor:pointer;"/>-->
				...
				<tr>
					<td class="mjoin"><img src="/mobile/html/images/text_0017.jpg" width="61" /></td>
					<td><label>
		...
		<tr>
			<td bgcolor="#f6f6f6" style="padding-bottom:20px;"><img src="/mobile/html/images/text_0022.jpg" width="360" height="50" />
				<table width="360" border="0" align="center" cellpadding="0" cellspacing="10">	  
				<tr>
					<td id="bt" class="mjoin"><img src="/mobile/html/images/text_0085.png" width="61" /></td>
					<td height="40">
				...
				<tr>
					<td class="mjoin" width="74"><img src="/mobile/html/images/text_0018.jpg" width="61" /></td>
					<td width="400"><label>
						<%
				...
				<tr>
					<td class="mjoin"><img src="/mobile/html/images/text_0019.jpg" width="61" /></td>
					<td height="40"><label>
				...
				<tr>
					<td class="mjoin"><img src="/mobile/html/images/text_0020.jpg" width="61" /></td>
					<td height="40">
					<label>
...
<script type="text/javascript">
	function fncSetPart(val,cd){
		fncAxListHtml("/mobile/common/inc/local_ax.asp?local="+val+"&localCd="+cd,"#part");
	}
