...
%>
        <div id="mcontainer">
			...
			<tr>
				<td style="padding-top:0px;"><img src="/mobile/html/images/sub04_subtitle02.jpg" width="360" /></td>
			</tr>
			<tr>
				<td><img src="/mobile/html/images/text_0034.jpg" width="360" border="0" usemap="#faq" /></td>
			</tr>
			</table>
			<p style="margin-top:10px;">
			<table width="360" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td width="90"><img src="/mobile/html/images/bt_0007_on.jpg" class="main_tab"  style="cursor:pointer; cursor:hand; width:90px; " /></td>
				<td width="90"><img src="/mobile/html/images/bt_0008_off.jpg" class="main_tab" style="cursor:pointer; cursor:hand; width:90px; border:0;" /></td>
				<td width="90"><img src="/mobile/html/images/bt_0009_off.jpg" class="main_tab" style="cursor:pointer; cursor:hand; width:90px; border:0;" /></td>
				<td width="90"><img src="/mobile/html/images/bt_0010_off.jpg" class="main_tab" style="cursor:pointer; cursor:hand; width:90px; border:0;" /></td>
			</tr>
			<tr>
...
<map name="faq" id="faq">
<area shape="rect" coords="11,67,167,98" href="/mobile/board/board_03.asp" /></map>
</body>
