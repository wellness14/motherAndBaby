...
<td width="360" valign="top">
			...
			<tr>
				<td width="360" style="padding-top:0px;"><img src="/mobile/html/images/sub04_subtitle0<%=linkNum%>.jpg" width="360" height="44" /></td>
			</tr>
			<tr>
			...
			<input type="hidden" name="mode" value="ins">
				<td bgcolor="#f6f6f6" style="padding-top:5px; padding-bottom:20px;">
					...
					<tr>
						<td width="74"><img src="/mobile/html/images/text_0011.jpg" width="74" /></td>
					...
					<!--tr>
						<td><img src="/mobile/html/images/text_0035.jpg" width="53" height="19" /></td>
						<td>
					...
					<tr>
						<td><img src="/mobile/html/images/text_0036.jpg" width="52" /></td>
						<td><input type="text" name="title" class="textarea" size="28" valid="E|M=200|A=제목을 입력해 주세요"/></td>
					</tr>
					<!--tr>
						<td><img src="/mobile/html/images/text_0037.jpg" width="53" height="19" /></td>
						<td><label>
						<input type="text" name="textfield24" class="textarea" size="35"/>
						&nbsp;&nbsp;<a href="#"><img src="/mobile/html/images/bt_0012.jpg" width="107" height="28" border="0" align="absmiddle" /></a></label></td>
					</tr-->
					<tr>
						<td><img src="/mobile/html/images/text_0038.jpg" width="52" /></td>
						<td><textarea name="content" class="textarea13" valid="E|M=3000|A=내용을 입력해 주세요"></textarea></td>
					</tr>
					<!--tr>
						<td><img src="/mobile/html/images/text_0039.jpg" width="74" height="15" /></td>
			...
			<tr>
				<td style="padding-top:20px; padding-bottom:10px;">
					<div align="center" id="btn11"><div class="btn00"><img src="/mobile/html/images/bt_0013.jpg" width="110" border="0" id="btnSubmit" style="cursor:pointer;"/></div><div class="btn00"><img src="/mobile/html/images/bt_0002.jpg" width="110" border="0" onClick="history.back(-1);" style="cursor:pointer;"/></div></div>
				</td>
			</tr>
			</table>
