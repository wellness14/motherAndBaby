...
%>
        <div id="mcontainer">
			...
			<tr>
				<td style="padding-top:0px;"><img src="/mobile/html/images/sub04_subtitle04.jpg" width="360"/></td>
			</tr>
			</table>
			<table width="360" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
			...
			<tr>
				...
				<td width="40" bgcolor="#979797" class="white_text"><div align="center">작성일1</div></td>
			</tr>
		<%
