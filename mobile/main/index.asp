	    ...
	    <div id="mslide" class="slider">
  			<div class="bd">
   				<ul>
					...
					<li><a target="_blank" href="#"><img src="/mobile/html/images/mslide4.jpg" alt=""/></a></li>
    			</ul>
  			</div>
  			<div class="hd">
            	<ul></ul>
...
#conmm9{width:360px;position:relative;}*/-->
		...
		<div id="mcontainer">
		 ...
		 <!--#include virtual="/mobile/common/menu/foot_menu.asp"-->	 
			...
			<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/938455758/?value=1.00&amp;currency_code=KRW&amp;label=YMYrCM_hhF8QzuW-vwM&amp;guid=ON&amp;script=0"/>
			</div>
			</noscript>
			...
			<script type="text/javascript">
				var roosevelt_params = {
					...
					tag_label:'ntwUi5G4Tlq8aBF1jxD3nw'
				};
			</script>
