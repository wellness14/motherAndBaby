...
%>
			...
			<tr>
				<td colspan="2" style="padding-top:0px;"><img src="/mobile/html/images/sub03_subtitle01.jpg" width="360" /></td>
			</tr>
			
			<tr>
				<td colspan="2" bgcolor="#f6f6f6" style="padding-bottom:20px;">
					<img src="/mobile/html/images/text_0041.jpg" width="360"  />
					<table width="360" border="0" align="center" cellpadding="0" cellspacing="10">
					<tr>
						<td style="padding-left:6px;" width="61"><img src="/mobile/html/images/text_0011.jpg" width="61"  /></td>
						<td width="200"><label>
							<input type="text" name="mem_nm" class="textarea" size="22" valid="E|M=5|T=이름|A=이름을 입력해 주세요"/>
						</label></td>
					</tr>
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0013.jpg" width="61" /></td>
						<td><label>
					...
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0014.jpg" width="61" /></td>
						<td>
							<label>
							...
							-
							<input type="text" name="phone_2" class="textarea" size="4" maxlength="4" valid="E|A=전화번호를 입력해 주세요"/>
							-
							<input type="text" name="phone_3" class="textarea" size="4" maxlength="4" valid="E|A=전화번호를 입력해 주세요"/>
						</td>
					</tr>	  	  	    	  
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0015.jpg" width="61" /></td>
						<td>
							<label>
					...
					<tr>
						<td style="padding-left:6px;" id="mbt5"><img src="/mobile/html/images/text_0016.jpg" width="61" /></td>
						<td>
							<input type="text" id="post_1" name="post_1" class="textarea" size="5" maxlength="3" readonly valid="E|A=우편번호를 입력해 주세요"/>
							-
							<input type="text" id="post_2" name="post_2" class="textarea" size="5" maxlength="3" readonly valid="E|A=우편번호를 입력해 주세요"/><br/>
					...
					<tr>
						<td>&nbsp;</td>
						<td><label>
							<input type="text" id="addr_1" name="addr_1" class="textarea" size="26" readonly valid="E|A=주소를 입력해 주세요"/>
						</label></td>
					</tr>	
					<tr>
						<td>&nbsp;</td>
						<td><label>
							<input type="text" name="addr_2" class="textarea" size="26" valid="E|A=상세주소를 입력해 주세요"/>
							&nbsp;&nbsp;</label>
						</td>
					</tr>
                    ...
                    <tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0085.png" width="51" /></td>
						<td>
			...
			<tr>
				<td colspan="2" bgcolor="#f6f6f6" style="padding-bottom:20px;"><img src="/mobile/html/images/text_0042.jpg" width="360"  />
					<table width="360" border="0" align="center" cellpadding="0" cellspacing="10">	  
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0043.jpg" width="83" /></td>
						<td width="229"> 
							<label>
								<input type="checkbox" name="check1" value="베이직프로그램" valid="E|A=신청서비스를 선택해 주세요"/>베이직프로그램&nbsp;&nbsp;
								<input type="checkbox" name="check1" value="프리미엄프로그램" />프리미엄프로그램&nbsp;&nbsp;<br>
								<input type="checkbox" name="check1" value="프라이빗프로그램" />프라이빗프로그램&nbsp;&nbsp;
								<input type="checkbox" name="check1" value="과체중" />과체중&nbsp;&nbsp;<br/>
								<input type="checkbox" name="check1" value="워킹맘" />워킹맘&nbsp;&nbsp;<br>
					...
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0044.jpg" width="83" /></td>
						<td height="40">
							<label>
								<input type="radio" name="radio1" value="1주" valid="E|A=이용기간을 선택해 주세요"/>1주&nbsp;&nbsp;
								<input type="radio" name="radio1" value="2주" />2주&nbsp;&nbsp;
								<input type="radio" name="radio1" value="3주" />3주&nbsp;&nbsp;<br>
								<input type="radio" name="radio1" value="4주" />4주&nbsp;&nbsp;
								<input type="radio" name="radio1" value="6주 이상" />6주 이상
							</label>
						</td>
					</tr>
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0045.jpg" width="83" /></td>
						<td height="40">
							<label>
							<input type="radio" name="radio2" value="출퇴근+5일" valid="E|A=이용형태를 선택해 주세요"/>출퇴근+5일&nbsp;&nbsp;
                            <input type="radio" name="radio2" value="출퇴근+6일" valid="E|A=이용형태를 선택해 주세요"/>출퇴근+6일&nbsp;&nbsp;
							<input type="radio" name="radio2" value="입주" />입주&nbsp;&nbsp;
							<input type="radio" name="radio2" value="입주+출퇴근" />입주+출퇴근
							</label>
						</td>
					</tr>	  	  	  
					<tr>
						<td style="padding-left:6px;" width="101"><img src="/mobile/html/images/text_0046.jpg" width="83" /></td>
						<td width="229"><label>
					...
					<tr>
						<td style="padding-left:6px;" width="101"><img src="/mobile/html/images/text_0047.jpg" width="83" /></td>
						<td width="229"><label>
					...
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0048.jpg" width="83" /></td>
						<td height="40"><label>
					...
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0049.jpg" width="83" /></td>
						<td height="40"><label>
					...
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0050.jpg" width="83" /></td>
						<td height="40"><label>
							<input type="checkbox" name="check2" value="없음" />없음&nbsp;&nbsp;
							<input type="checkbox" name="check2" value="다둥이" />다둥이&nbsp;&nbsp;
							<input type="checkbox" name="check2" value="임신성 당뇨" />임신성 당뇨 &nbsp;&nbsp;<br>
							<input type="checkbox" name="check2" value="부종" />부종&nbsp;&nbsp;
							<input type="checkbox" name="check2" value="고혈압" />고혈압
						</label></td>
					</tr>	  
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0051.jpg" width="83" /></td>
						<td height="40"><label>
							<input type="checkbox" name="check3" value="부모님" valid="E|A=가족사항을 선택해 주세요"/>부모님&nbsp;&nbsp;
							<input type="checkbox" name="check3" value="남편" />남편 &nbsp;&nbsp;
							<input type="checkbox" name="check3" value="큰아이 1명" />큰아이 1명&nbsp;&nbsp;<br>
							<input type="checkbox" name="check3" value="큰아이 2명이상" />큰아이 2명이상&nbsp;&nbsp;
							<input type="checkbox" name="check3" value="기타가족" />기타가족
						</label></td>
					</tr>	
					<tr>
						<td style="padding-left:6px;"><img src="/mobile/html/images/text_0052.jpg" width="83" /></td>
						<td><label>
							<textarea name="textarea" class="textarea8" valid="E|A=상담내용을 입력해 주세요"></textarea>
						</label></td>
					</tr>	  	  
					</table>
				</td>	
...
※    환불규정
가. 서비스 예약 취소는 서비스 시작 15일 이전에 '마더앤베이비'에 통보함을 원칙으로 하며, 이 때 납입된 예약금은 전액 환불 됩니다. 

나. 서비스 이용예정일 15일 이전 임신 30주(7일 이전) : 예약금 전액 환불
...
1. 출퇴근형의 근무시간은 평일 09:00~18:00, 토요일 09:00~16:00, 일요일은 휴무입니다. 
...
3. 주 5일 출퇴근형의 근무시간은 평일 09:00~19:00, 토/일요일은 휴무입니다.
...
4. 경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)
            ...
            <tr>
				<td colspan="2" style="padding-top:30px; padding-bottom:25px;">
					<div align="center" id="btn11">
						<div class="btn00"><img src="/mobile/html/images/bt_0014.jpg" width="110"  border="0" id="btnSubmit" style="cursor:pointer;"/></div>
...
<script type="text/javascript">
	...
	function fncOpenZip_layer(){
		    ...
		    jQuery.get("/mobile/member/pop_zipcode_ax.asp",{"type":"", "idx":""},function(data,testStatus){
