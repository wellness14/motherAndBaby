	...
	<div id="wrap">
        ...
        <div id="mcontainer">
        	<ul>
				...
				<% If menuCode2 = "B" Then %>
				<li><img src="/mobile/html/images/sub32.jpg" width="360px" border="0" ></li>
                <% ElseIf menuCode2 = "C" Then %>
				<li><img src="/mobile/html/images/sub34.jpg" width="360px" border="0" ></li>
                <% ElseIf menuCode2="D" Then %>
				<li><img src="/mobile/html/images/sub34.jpg" width="360px" border="0" ></li>
				<% ElseIf menuCode2="E" Then %>
				<li><img src="/mobile/html/images/sub35.jpg" width="360px" border="0" ></li>
				<% ElseIf menuCode2="F" Then %>
				<li><img src="/mobile/html/images/sub36.jpg" width="360px" border="0" ></li>
				<% End if%>
            </ul>
        </div>
