	...
	<tr>
		...
		<td width="850" valign="top"><table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<textarea name="textarea" class="textarea4">마더앤베이비 서비스 이용약관
...
4. 본 약관을 동의함은 ‘마더앤베이비’의 산모신생아건강관리사에 대한 소개를 동의한 것으로 간주합니다.
...
가. 케어매니저 : 케어매니저(고객 담당자 또는 실장 및 지사장 이하 매니저)는 고객과 정기적인 연락을 통해 상담을 제공합니다.
...
라. 방문 산전산후 바디케어 : 전문적이고 체계적인 교육을 이수하여 오랜 기간 산후 바디케어 경력을 보유한 방문 테라피스트는, 산모님들의 체계적인 산전/산후를 위하여 방문지도 및 바디케어 테라피 업무를 수행합니다. 또한 원활한 산욕기를 보낼 수 있도록 모유수유 코치 및 바디케어 컨설팅을 수행합니다.
 
마. 부가서비스 지원 : 회원님의 필요에 따라 다양한 분야의 전문가들을 통해 부가서비스를 지원하며 국제모유수유자격증자, 반찬도우미, 베이비시터, 가사도우미, 주거환경 점검을 통한 소독 및 청소 등의 서비스를 지원합니다.

바. 주차별 맞춤정보 제공 : 회원님의 필요에 따라 회원님의 임신과 출산에 필요한 서비스와 유아동 및 출산용품의 정보를 임신 주차별로 마더앤베이비의 본사 또는 관계사 및 협력기관을 통하여 제공합니다.
...
6. [마더앤베이비 웹사이트]는 회원이 서비스 이용 중 필요하다고 인정되는 다양한 정보에 대해서 전자메일이나 서신우편, 전화, SMS, 푸시메일, 애플리케이션 등의 방법으로 회원에게 제공할 수 있으며, 회원은 원하지 않을 경우 회원정보수정 메뉴에서 정보수신 거부를 할 수 있습니다.
...
3. 서비스는 임신 20주부터 시작됨을 원칙으로 하고, 예약 시 규정된 서비스 이용금액이 입금되어야만 서비스가 시작됩니다.
...
1. 분만일의 변동, 수술일자 변경, 서비스 이용기간 변경 등의 예약사항의 변동이 있을 시, 이용자 또는 이용자의 보호자는 최소 10일 이전에 반드시 '마더앤베이비'에 해당 사실을 통보하여야 합니다. 이를 소홀히 하여 서비스에 차질이 발생할 경우, '마더앤베이비'는 산모의 원활한 산후조리를 위해 성실의 의무를 다하나, 책임은 이용자가 집니다.

2. '마더앤베이비'가 고객과 서비스를 협의하여 예약금을 입금 받은 경우, 이후 서비스 금액이 인상되더라도 예약금을 입금 받아 계약이 성립된 일자에 체결되는 계약으로 적용합니다.
...
※    환불규정
가. 서비스 예약 취소는 서비스 시작일(시작일이라 함은 출산예정일을 말합니다.) 15일 이전에 '마더앤베이비'에 통보함을 원칙으로 하며, 이 때 납입된 예약금은 전액 환불 됩니다. 

나. 서비스 이용예정일 15일 이전 임신 30주(7일 이전) : 예약금 전액 환불
 
  - 임신 31주 ~ 38주 : 제공된 서비스 및 지급된 상품 금액 제외한 예약금의 나머지 금액 환불 

  - 임신 38주 ~ 분만 전 : 제공된 서비스 및 지급된 상품금액과 예약금의 20% 취소 수수료를 제외한 나머지 금액 환불

- 분만일 ~ 서비스 종료일 : 제공된 서비스와 지급된 상품금액 및 기간별 수수료를 제외한 나머지 금액 환불 

5. 회사는 부득이 한 경우(상품 변경, 유산, 사산, 조산 등)에 서비스 시작 전 이용자와 협의하여 예약을 취소할 수 있으며, 이 때 납입된 이용금액을 전액 환불합니다. 

제 9조 (서비스 이용요금 및 결제)

1. 서비스 이용요금은 '마더앤베이비'에서 정한 이용요금을 기준으로 하며, 고객과의 상담을 통해최종적인 서비스 예약 시 '마더앤베이비'와 이용자간 합의된 금액입니다. 

2. 서비스 예약 시 예약금은 서비스 신청일 기준으로 7일 이내에 무통장 또는 온라인결제로 납입하며 산후관리사 임금은 서비스 종료 시 고객님의 사정에 따라 산모신생아건강관리사에게 직접 지불합니다. 단, 불가항력적으로 회사로 지급하는 경우에는 회사가 산모신생아건강관리사에게 대지급 하는 것에 동의하며 고지를 통한 절차에 따라 지급 합니다. 고객은 잘 전달되었는지 필요 시 담당자를 통하여 확인할 수 있습니다.

제 10조 (서비스 이용기간 및 연장)

1. 산후관리사 서비스 이용기간 은 최소 1주(5일)를 기본으로 하며, 주단위로 서비스가 제공됩니다.

2. 서비스 이용기간 연장/변경 요청 시, '마더앤베이비'는 담당자를 통해 연장/변경 가능여부를 확인하여 고객에게 통보합니다. 
...
1. 이용자 및 '마더앤베이비'는 다음의 경우 산후관리사 교체 또는 서비스 중도 해지를 요청할 수있습니다. 
 ...
 다. 산모신생아건강관리사가 의료행위를 하려 하거나 강요하는 경우
   - 산모신생아건강관리사는 산모와 신생아를 대상으로 그 어떠한 의료행위도 할 수 없으며 이용자는 의료행위를 요구하거나 응해서는 안됩니다. 단, 전담 방문간호사는 해당자격이 있는 의료인으로서 간단한 응급처치를 포함하여 산모와 신생아의 건강 사정과 관련된 각종 신체 검진은 행해질 수 있습니다. 또한 산모와 신생아의 신체 검진 상 전문의 소견을 필요로 할 때에는 주치의 진료를 권유할 수 있습니다
...
1. 출퇴근형의 근무시간은 평일 09:00~18:00, 토요일 09:00~14:00, 일요일 및 공휴일은 휴무입니다. 
...
3. 법정 공휴일은 휴무이며, 휴무된 기간만큼 자동 연장됩니다. 단, 휴무기간에 서비스 제공을 요청하시면 상황에 따라 상호 협의하여 근무를 실시하며 규정에 의해 휴일근무 비용이 추가로 발생합니다.

4. 고객센터 운영시간은 평일 09:30~18:30, 토요일, 일요일, 공휴일은 휴무입니다.
...
1. '회사'가 서비스 제공 및 운영 관련 주요 공지사항을 회원에게 통지 하는 경우, 회원이 ‘회사에 제출한 전자우편 주소 및 휴대전화번호, 일반전화번호의 문자서비스, 동의된 SNS 메시지 및 알림서비스와 직접전화로 수행 할 수 있습니다.
...
2. "회사"는 서비스제공의 이유로 이용자의 개인 식별이 가능한 개인정보를 수집하는 때에는 반드시 서비스약관 등을 통하여 이용자의 동의를 받습니다.

3. 제공된 개인정보는 이용자의 동의 없이 별도의 목적으로 이용되거나 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은 '회사'가 집니다. 단, 다음의 경우에는 예외로 합니다.
 
가. 산모신생아건강관리사, 방문간호사, 바디케어테라피 및 무료임대용품 배송업체에게 필요한 최소한의 이용자의 정보(성명, 주소, 전화번호)를 알려주는 경우

나. 보건소를 포함한 행정기관, 통계작성, 학술연구 또는 시장조사를 위한 것으로서 특정 개인을 식별할 수 없는 형태로 제공하는 경우 
...
1. '회사'는 개인정보 수집 및 이용목적이 달성된 후에는 2년간 보관하도록 하며 이후 예외 없이 해당 정보를 지체 없이 파기합니다. 
...
1. '마더앤베이비'의 서비스 기간 중 산모신생아건강관리사 및 전담방문간호사의 고의, 과실 등으로 인해 이용자에게 피해가 발생하였을 경우 이용자는 회사에서 가입한 ‘배상책임보험’에 의해 보상받을 수 있습니다. 
...
1. '마더앤베이비'의 정보는 회원의 동의('개인정보취급방침')를 통하여 웰니스인텔리전스가 운영하는 '맘앤샵(www.momnshop.com)' 및 맘스초이스맘초(www.momcho.co.kr)의 홈페이지에 개인정보(아이디, 비밀번호, 이름, 성별, 생년월일, 출산예정일, 이메일, 휴대폰번호, 일반전화번호, 주소)를 연동하게 됩니다.

2. '맘앤샵'(이하 '몰'이라 한다)이란 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
3. ‘맘스초이스맘초’(이하 ‘서비스’라 한다)는 회사가 제공하는 산후조리 중계서비스로서 이용자에게 산후조리 서비스 및 산후조리콘텐츠를 제공하는 서비스 입니다.
