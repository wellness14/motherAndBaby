...
<body onload="fn_onlyOneChk(this);">
			...
			<tr>
				<td colspan="2" bgcolor="#f6f6f6" style="padding-bottom:20px;"><img src="/image/text_0007.jpg" width="770" height="49" />
					...
					<tr>
						...
						<td><label>
								<select id="add_hp_1" name="add_hp_1" class="textarea" style="height:35px;" valid="E|A=보호자번호를 선택해 주세요">
									<option value="">선택</option>
									<option value="010">010</option>
									<option value="011">011</option>
									<option value="016">016</option>
							...
							-
							<input type="text" id="add_hp_2" name="add_hp_2" class="textarea" size="5" maxlength="4" valid="E|A=보호자번호를 선택해 주세요"/>
							-
							<input type="text" id="add_hp_3" name="add_hp_3" class="textarea" size="5" maxlength="4" valid="E|A=보호자번호를 선택해 주세요"/>&nbsp;&nbsp;
						</td>
					</tr>
					<tr>
						<td></td>
...
<script type="text/javascript">
	...
	var hp1 = $('#hp_1').attr('value');
	var hp2 = $('#hp_2').attr('value');
	var hp3 = $('#hp_3').attr('value');

	var add_hp_1 = $('#add_hp_1').attr('value');
	var add_hp_2 = $('#add_hp_2').attr('value');
	var add_hp_3 = $('#add_hp_3').attr('value');


	var hp = hp1 + hp2 +  hp3;
	var hp = add_hp_1 + add_hp_2 +  add_hp_3;
