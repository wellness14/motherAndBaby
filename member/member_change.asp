		...
		<td width="850" valign="top">
			...
			<tr>
				...
				<tr>
						...
						<td><label>
						<%
							If arrList(17,0) <> "" then
							add_arrHp = Split(arrList(17,0),"-")
							
						%>
							<select name="add_hp_1" class="textarea" style="height:35px;" valid="E|A=연락가능번호를 입력해주세요">
								<option value="">선택</option>
						...
						-
						<input type="text" name="add_hp_2" class="textarea" size="5" maxlength="4" value="<%=add_arrHp(1)%>" valid="E|A=연락가능번호를 입력해주세요"/>
						-
						<input type="text" name="add_hp_3" class="textarea" size="5" maxlength="4" value="<%=add_arrHp(2)%>" valid="E|A=연락가능번호를 입력해주세요"/>&nbsp;&nbsp;
					<%else%>
					<select name="add_hp_1" class="textarea" style="height:35px;" valid="E|A=연락가능번호를 입력해주세요">
								<option value="">선택</option>
						...
						-
						<input type="text" name="add_hp_2" class="textarea" size="5" maxlength="4" value="" valid="E|A=연락가능번호를 입력해주세요"/>
						-
						<input type="text" name="add_hp_3" class="textarea" size="5" maxlength="4" value="" valid="E|A=연락가능번호를 입력해주세요"/>&nbsp;&nbsp;
				...
				<tr>
					...
					<td>
						<input type="text" id="post" name="post" class="textarea" size="5" maxlength="3" value="<%=Left(arrList(7,0),3)%>" readonly valid="E|A=우편번호를 입력해 주세요"/> 
						&nbsp;&nbsp;<img src="/image/bt_0004.jpg" width="107" height="28" border="0" align="absmiddle" id="post_btn" style="cursor:pointer;"/>
					</td>
				</tr>	
				<tr>
					<td>&nbsp;</td>
					<td><label>
						<input type="text" id="address1" name="address1" class="textarea" size="60" value="<%=arrList(8,0)%>"  readonly valid="E|A=주소를 입력해 주세요"/>
					</label></td>
				</tr>	
				<tr>
					<td>&nbsp;</td>
					<td><label>
						<input type="text" id="address2" name="address2" class="textarea" size="35" value="<%=arrList(9,0)%>" valid="E|A=상세주소를 입력해 주세요"/>&nbsp;&nbsp;
					</label></td>
				</tr>	
				<tr>
