...
<HEAD>
 ...
 <%
	...
	strWhere = " WHERE MO_DATA_ADD_SEQ = '"& idx &"' "
	...
	strSql = strSql & "		  , ROW_NUMBER( ) OVER (ORDER BY MO_DATA_ADD_SEQ DESC) ROWNUM  "
			...
			<tr>
				...
				<td>
					<select name="cate" id="cate">
						...
						<option value="입주·출퇴근">입주·출퇴근</option>
					</select>
				</td>
			</tr>
			<tr>
				<th>가족유형</th>
				<td>
					<select name="fam_type" id="fam_type">
						<option value="">선택</option>
						<option value="미취학아동">미취학아동</option>
						<option value="취학아동">취학아동</option>
						<option value="기타인원">기타인원</option>
						<option value="휴일근무(1일)">휴일근무(1일)</option>
						<option value="쌍둥이케어(1일)">쌍둥이케어(1일)</option>
						<option value="시간초과(1시간)">시간초과(1시간)</option>
					</select>
				</td>
			</tr>
			<tr>
