	...
	<div id="container">
		...
		<div class="write">
			...
			<tr>
				<th>신청서비스</th>
				<td>
					<% If Not IsNull(arrList(9,0)) And Not arrList(9,0) = "" Then %>
						<%=Replace(arrList(9,0),"||", ", ")%>
					<% End If %>
				</td>
			</tr>
			...
			<tr>
				<th>특이사항</th>	
				<td>
					<% If Not IsNull(arrList(16,0)) And Not arrList(16,0) = "" Then %>
						<%=Replace(arrList(16,0),"||", ", ")%>
					<% End If %>
				</td>
			</tr>
			<tr>
				<th>가족사항</th>	
				<td>
					<% If Not IsNull(arrList(17,0)) And Not arrList(17,0) = "" Then %>
						<%=Replace(arrList(17,0),"||", ", ")%>
					<% End If %>
				</td>
			</tr>
			<tr>
