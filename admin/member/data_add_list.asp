	...
	<div id="container">
		...
		<div class="write">
			...
			<div class="selection">
				...
				<a onClick="location.href='./data_list.asp';" style="cursor:pointer;" class="button">서비스상품목록</a>
...
<%
	...
	If IsArray(arrList) Then 
		For num=0 To UBound(arrList,2)		
			...
			fam_type	= arrList(3,num)
			term		= arrList(4,num)
			price		= arrList(5,num)

%>
 
			<tr onclick="location.href='./data_add_ins.asp?idx=<%=idx%>'" style="cursor:pointer;">
