...
<% If mem_seq <> "" Then  %>
			...
			<tr>
				<th>성별</th>
				<td>
					<input type="radio" name="radio1" value="2" <%=fncSetCheckBox("2",arrList(4,0))%> valid="E|A=성별을 선택해 주세요"/> 여자&nbsp;&nbsp;
					<input type="radio" name="radio1" value="1" <%=fncSetCheckBox("1",arrList(4,0))%>/> 남자
				</td>
			</tr>
			<tr>
				<th>생년월일</th>
			...
			<tr>
				...
				%>
					...
					<input type="checkbox" name="check3" value="Y" <%=fncSetCheckBox("Y",arrList(10,0))%>/> SMS 수신동의	
				</td>
			</tr>
			<tr>
				<th>주소</th>
			...
			<tr>
				<th>이메일</th>
				<td>
					<input type="text" name="email" class="textarea" size="35" value="<%=arrList(9,0)%>" valid="E|A=이메일 주소를 입력해 주세요"/>&nbsp;&nbsp;
					<input type="checkbox" name="check4" value="Y" <%=fncSetCheckBox("Y",arrList(11,0))%>/> 이메일 수신동의 
				</td>
			</tr>
			<tr>
				<th>지점</th>
...
<% Else %>
			...
			<tr>
				<th>회원명</th>
				<td><input type="text" name="mem_name" class="textarea" size="35" value="" valid="E|A=이름을 입력해 주새요"/>&nbsp;&nbsp;</td>
			</tr>
			<!--tr>
				<th>가입일</th>
				<td>
			...
			<tr>
				<th>이메일</th>
				<td>
					<input type="text" name="email" class="textarea" size="35" value="" valid="E|A=이메일 주소를 입력해 주세요"/>&nbsp;&nbsp;
