...
<%
    ...
    If intIDX <> "" Then
		...
		If Not Rs.EOF Then
			...
			mr_visit_date				= Rs(80) ' 상담자 메모 관리자만 볼수있음. -- 사용안함
			mr_visit_time				= Rs(81) ' 상담자 메모 관리자만 볼수있음. -- 사용안함
			...
			visit_post					= Rs(87) ' 상담자 메모 관리자만 볼수있음. -- 사용안함
			visit_addr_1				= Rs(88) ' 상담자 메모 관리자만 볼수있음. -- 사용안함
			visit_addr_2				= Rs(89) ' 상담자 메모 관리자만 볼수있음. -- 사용안함
		...
		<div class="write">
			...
			<tr>
				...
				<td>	
					...
					<input type="checkbox" name="check1" value="쌍둥이" <%If InStr(service,"쌍둥이") > 0 Then%>checked<%End If%>/> 쌍둥이&nbsp;&nbsp;
					<input type="checkbox" name="check1" value="다둥이" <%If InStr(service,"다둥이") > 0 Then%>checked<%End If%>/> 다둥이&nbsp;&nbsp;
					<input type="checkbox" name="check1" value="바우처" <%If InStr(service,"바우처") > 0 Then%>checked<%End If%>/> 바우처&nbsp;&nbsp;
			...
			<tr>
				...
				<td>
					...
					<input type="radio" name="radio1" value="5주" <%=fncSetCheckBox(period,"5주")%> /> 5주&nbsp;&nbsp;
				...
				<td style="vertical-align:middle;">1) 유축기    <select name="product_1"   class="textarea" style="height:35px;">
						...
						<tr>
							...
							<td>산전 <input type="text" name="massage1" size="10" maxlength="10" value="<%=product_MASSAGE_BEFORE%>"/> 회 &nbsp&nbsp
								...
								연락처 <select name="massage_hp1" id="massage_hp1">
										<option value="">선택</option>
									...
									마사지날짜 <input type="text" id="datepicker16" name="massage_date" value="<%=mr_bodycare_date_ymd%>"> 
							</td>
						</tr>
						<tr>
							<th>방문간호사</th>
							<td>산전 <input type="text" name="Q14_1" size="10" maxlength="10" value="<%=product_VISIT_NURSE_BEFORE%>"/> 회 &nbsp&nbsp
								...
								연락처 <select name="Q14_hp1" id="Q14_hp1">
										<option value="">선택</option>
									...
									방문날짜 <input type="text" id="datepicker17" name="nurse_date" value="<%=mr_nurse_date_ymd%>"> 
							</td>
						</tr>
						<tr>
							<th>소독서비스</th>
							<td><select name="Q15_Y" >
								...
								연락처 <select name="Q15_hp1" id="Q15_hp1">
										<option value="">선택</option>
									...
									소독서비스날짜 <input type="text" id="datepicker15" name="sodok_date" value="<%=mr_sodok_date_ymd%>"> 
							</td>
						</tr>
						<tr>
							<th>모유성분 분석서비스</th>
							<td><select name="mom_milk_service" >
									<option value="">선택</option>
									<option value="Y" <%=fncSetSelectBox("Y",mom_milk_service)%>>신청함</option>
									<option value="N" <%=fncSetSelectBox("N",mom_milk_service)%>>신청안함</option>
								</select>
								담당자 <input type="text" name="mom_milk_service_mng" size="10" maxlength="10" value="<%=mom_milk_mng%>"/> &nbsp&nbsp&nbsp&nbsp
								연락처 <select name="mom_milk_hp1" id="mom_milk_hp">
										<option value="">선택</option>
									...
									모유분석서비스날짜 <input type="text" id="datepicker18" name="milk_analysis_date" value="<%=mr_mmilk_analysis_date_ymd%>"> 
							</td>
						</tr> 
						<tr>
							<th>모유수유 마사지서비스</th>
							<td><select name="mom_milk_msg_service" >
									<option value="">선택</option>
									<option value="Y" <%=fncSetSelectBox("Y",mom_milk_msg_ser)%>>신청함</option>
									<option value="N" <%=fncSetSelectBox("N",mom_milk_msg_ser)%>>신청안함</option>
								</select>
								담당자 <input type="text" name="mom_milk_msg_mng" size="10" maxlength="10" value="<%=mom_milk_msg_mng%>"/> &nbsp&nbsp&nbsp&nbsp
								마사지횟수 <input type="text" name="mom_milk_msg_cnt" size="10" maxlength="10" value="<%=mom_milk_msg_cnt%>"/> &nbsp&nbsp&nbsp&nbsp
								연락처 <select name="mom_milk_msg_hp1" id="mom_milk_msg_hp1">
										<option value="">선택</option>
									...
									모유수유마사지날짜 <input type="text" id="datepicker19" name="mom_milk_msg_date" value="<%=mr_milk_msg_date_ymd%>"> 
							</td>
						</tr>
						<tr>
							<th>산후도우미 방문날짜</th>	
							<td><input type="text" id="datepicker14" name="helper_visit_date" value="<%=mr_visit_date_ymd%>"> 
								<input type="text" name="helper_visit_time"	  id="helper_visit_time" size="5"	maxlength="2" value="<%=visit_time%>"/>시
								<input type="text" name="helper_visit_minute" id="helper_visit_minute" size="5" maxlength="2" value="<%=visit_minute%>"/>분
 ...
 <% End If %>
			...
			<tr>
				...
				<td>
					...
					<input type="checkbox" name="check2" value="고위험" <%If InStr(unique,"고위험") > 0 Then%>checked<%End If%>/> 고위험&nbsp;&nbsp;
			...
			<tr>
				...
				<td>
					...
					<input type="checkbox" name="check3" value="반려견"  <%If InStr(family,"반려견") > 0 Then%>checked<%End If%>/> 반려견
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<input type="radio" name="radio5" value="현금" <%If InStr(payType,"현금") > 0 Then%>checked<%End If%>/> 현금 &nbsp;&nbsp;
				</td>
			</tr>
			<tr>
				<th>결제 상태</th>	
...
'코멘트 불러오기
	...
	%>
			...
			<tr>
				<th>연장금1</th>	
				<td>
					<input type="text" name="add_payment1" id="add_payment1" numberonly="true" size="7" maxlength="7" value="<%If mr_add1_pay <> "" Then%><%=FormatNumber(mr_add1_pay,0)%><%End If%>" class="numberic" style="ime-mode:disabled"/> 원
				</td>
			</tr>
			<tr>
				<th>산모도우미선택1</th>	
...
'  MD_HELPER_SEQ 쿼리로   연장 0 인 사람 이름 찾기 
	...
	%>
			...
			<tr>
				<th>연장금2</th>	
				<td>
					<input type="text" name="add_payment2" id="add_payment2" numberonly="true" size="7" maxlength="7" value="<%If mr_add2_pay <> "" Then%><%=FormatNumber(mr_add2_pay,0)%><%End If%>" class="numberic" style="ime-mode:disabled"/> 원
				</td>
			</tr>
			<tr>
				<th>산모도우미선택2</th>	
...
'  MD_HELPER_SEQ 쿼리로   연장 0 인 사람 이름 찾기 
	...
	%>
			...
			<tr>
				<th>연장금3</th>	
				<td>
					<input type="text" name="add_payment3" id="add_payment3" numberonly="true" size="7" maxlength="7" value="<%If mr_add3_pay <> "" Then%><%=FormatNumber(mr_add3_pay,0)%><%End If%>" class="numberic" style="ime-mode:disabled"/> 원
				</td>
			</tr>
			<tr>
				<th>산모도우미선택3</th>	
  ...
  //크롬등에서 ime-mode:disabled 정상작동 되지않으므로 정규식으로 처리
   ...
   function onlyNumber(){
	...
	btnSubmit.click(function(){
		if ($("#id_search").val() == "F") {
			alert("회원정보를 조회하여 회원ID를 입력해 주세요.");
			$("#mem_id").focus();
			return false;
		}
