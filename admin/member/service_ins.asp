	...
	<div id="container">
		...
		<div class="write">
			...
			<tr>
				<th>주소</th>
				<td>
					<input type="text" name="post_1" class="textarea" size="5" maxlength="3" value="<%=Left(arrList(6,0),3)%>"/>
					-
					<input type="text" name="post_2" class="textarea" size="5" maxlength="3" value="<%=Right(arrList(6,0),3)%>"/>

					<input type="text" name="addr_1" class="textarea" size="60" value="<%=arrList(7,0)%>"/>
					<input type="text" name="addr_2" class="textarea" size="35" value="<%=arrList(8,0)%>"/>
				</td>
			</tr>
			<tr>
				<th>관리사주민번호</th>	
			...
			<tr>
				<th>신청서비스</th>
				<td>	
					<input type="checkbox" name="check1" value="베이직프로그램" <%If InStr(arrList(9,0),"베이직프로그램") > 0 Then%>checked<%End If%>/> 베이직프로그램&nbsp;&nbsp;
			...
			<tr>
				<th>이용기간</th>	
				<td>
					<input type="radio" name="radio1" value="1주" <%=fncSetCheckBox("1주",arrList(10,0))%>/> 1주&nbsp;&nbsp;
			...
			<tr>
				<th>이용형태</th>	
				<td>
					<input type="radio" name="radio2" value="출퇴근 주5일" <%=fncSetCheckBox("출퇴근 주5일",arrList(11,0))%>/> 출퇴근 주5일&nbsp;&nbsp;
					<input type="radio" name="radio2" value="출퇴근 주6일" <%=fncSetCheckBox("출퇴근 주6일",arrList(11,0))%>/> 출퇴근 주6일&nbsp;&nbsp;
			...
			<tr>
				<th>조리원 이용</th>	
				<td>
					<input type="radio" name="radio3" value="이용함" <%=fncSetCheckBox("이용함",arrList(14,0))%>/> 이용함&nbsp;&nbsp;
			...
			<tr>
				<th>출산경험</th>	
				<td>
					<input type="radio" name="radio4" value="초산모" <%=fncSetCheckBox("초산모",arrList(15,0))%>/> 초산모&nbsp;&nbsp;
			...
			<tr>
				<th>특이사항</th>	
				<td>
					<input type="checkbox" name="check2" value="쌍둥이" <%If InStr(arrList(16,0),"쌍둥이") > 0 Then%>checked<%End If%>/> 쌍둥이&nbsp;&nbsp;
			...
			<tr>
				<th>가족사항</th>	
				<td>
					<input type="checkbox" name="check3" value="부모님" <%If InStr(arrList(17,0),"부모님") > 0 Then%>checked<%End If%>/> 부모님&nbsp;&nbsp;
			...
			<tr>
				<th>관리자메모</th>	
				<td><textarea name="textarea_2" style="width:500px;height:200px;" valid="E|A=관리자메모를 입력해 주세요"><%=arrList(27,0)%></textarea></td>
			</tr>
			</thead>
			</table>
			</form>
