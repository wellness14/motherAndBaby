...
'---------------------------------------------------------
	...
	strWhere = " WHERE MR_CNLKBN='N' and  (MR_PAY_STATE = '결제진행중' or  MR_PAY_STATE = '' or  MR_PAY_STATE  is NULL) "
...
<body>
	<div id="container">
		<div class="linemap">마더앤베이비 > 회원관리 > <strong>대기 리스트</strong></div>
		<div class="write">
			...
			<div class="selection">
				...
				<a onClick="location.href='./data_res_list_test_ctm_app.asp';" style="cursor:pointer;" class="button">전체 리스트</a>
				<span style="margin-left:20px;">
					<a onClick="location.href='./data_res_test_ctm_app.asp'" style="cursor:pointer;" class="button">등록</a>
				</span>
			</div>
			</form>
			<br />
...
%>
			<tr onclick="location.href='./data_res_test_ctm_app.asp?idx=<%=idx%>'" style="cursor:pointer;">
