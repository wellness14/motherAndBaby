	...
	<div id="container">
		...
		<div class="write">
			...
			<div class="selection">
				...
				<a onClick="location.href='./data_res_list_test.asp';" style="cursor:pointer;" class="button">전체 리스트</a>
				<span style="margin-left:20px;">
					<a onClick="location.href='./data_res_test.asp'" style="cursor:pointer;" class="button">등록</a>
				</span>
			</div>
			</form>
			<br />
...
%>
			<tr onclick="location.href='./data_res_test.asp?idx=<%=idx%>'" style="cursor:pointer;">
