...
'---------------------------------------------------------
	...
	strWhere = " WHERE MR_CNLKBN='N'  and   (SELECT CONVERT(varchar(30), GETDATE(), 112))  >  MR_SERVICEEDT and MR_PAY_STATE = '결제완료' and (MR_CANCEL_YN = 'N' or MR_CANCEL_YN ='' or  MR_CANCEL_YN is null ) "
...
<body>
	<div id="container">
		<div class="linemap">마더앤베이비 > 회원관리 > <strong>진행종료 리스트</strong></div>
		<div class="write">
...
<%
	If IsArray(arrList) Then 
		For num=0 To UBound(arrList,2)		
			...
			End If
%>
			<tr onclick="location.href='./member_reser_ins.asp?idx=<%=idx%>&listKind=end'" style="cursor:pointer;background:<%=trBackground%>;">
