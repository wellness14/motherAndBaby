...
<body>
	<div id="container">
		...
		<div class="write">
			...
			<tr>
				<th>생년월일</th>
				<td>
					<input type="text" id="datepicker" name="birth" value="<%=birth_ymd%>"> 
			...
			<tr>
				...
				<td>	
					...
					<input type="checkbox" name="check1" value="쌍둥이프로그램" <%If InStr(service,"쌍둥이프로그램") > 0 Then%>checked<%End If%>/> 쌍둥이&nbsp;&nbsp;
					<input type="checkbox" name="check1" value="다둥이프로그램" <%If InStr(service,"다둥이프로그램") > 0 Then%>checked<%End If%>/> 다둥이&nbsp;&nbsp;
			...
			<tr>
				...
				<td>
                    ...
                    <input type="radio" name="radio2" value="입주 + 5일" <%=fncSetCheckBox(service_type,"입주 + 5일")%>/> 입주 + 5일&nbsp;&nbsp;
					<input type="radio" name="radio2" value="입주 + 6일" <%=fncSetCheckBox(service_type,"입주 + 6일")%>/> 입주 + 6일&nbsp;&nbsp;
					<input type="radio" name="radio2" value="출퇴근 + 입주 + 5일" <%=fncSetCheckBox(service_type,"출퇴근 + 입주 + 5일")%>/> 출퇴근 + 입주 + 5일&nbsp;&nbsp;
					<input type="radio" name="radio2" value="출퇴근 + 입주 + 6일" <%=fncSetCheckBox(service_type,"출퇴근 + 입주 + 6일")%>/> 출퇴근 + 입주 + 6일&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
				<th>출산예정일</th>	
 ...
 <% If uId = "wellness14" Then %>
					...
					%>
							 ...
							 택배일 <select name="Q16_Y">
								...
								<% For num=Year(DateAdd("yyyy",3,Date())) To Year(DateAdd("yyyy",-40,Date())) Step -1 %>
									<option value="<%=num%>" <%=fncSetSelectBox(num,Left(product_GIFT_CHOICE_SEND,4))%>><%=num%></option>
								<% Next %>						
								</select>
								<select name="Q16_M" >
									<option value="">월</option>
			...
			<tr>
				<th>출산선물박스 택배일</th>
				<td> <select name="Q17_Y">
						<option value="">년</option>
							<% For num=Year(DateAdd("yyyy",3,Date())) To Year(DateAdd("yyyy",-40,Date())) Step -1 %>
								<option value="<%=num%>" <%=fncSetSelectBox(num,Left(product_GIFT_BOX_SEND,4))%>><%=num%></option>
							<% Next %>						
							</select>
							<select name="Q17_M" >
								<option value="">월</option>
				...
				<td style="vertical-align:middle;">1) 유축기    <select name="product_1"   class="textarea" style="height:35px;">
						...
						<input type="text" name="product_price" size="10" maxlength="10" value="<%=product_CHOICE_PRICE%>"/> 원
						 <span style="margin-left:20px;"></span>
							2) 조사기&nbsp&nbsp<select name="Q12_Y">
									<option value="">년</option>
									<% For num=Year(DateAdd("yyyy",3,Date())) To Year(DateAdd("yyyy",-40,Date())) Step -1 %>
										<option value="<%=num%>" <%=fncSetSelectBox(num,Left(product_OUT_DAY,4))%>><%=num%></option>
									<% Next %>
									</select>
									<select name="Q12_M" >
										<option value="">월</option>
						...
						<tr>
							...
							<td>산전 <input type="text" name="massage1" size="10" maxlength="10" value="<%=product_MASSAGE_BEFORE%>"/> 회 &nbsp&nbsp
								...
								담당자 <input type="text" name="massage_mng" size="10" maxlength="10" value=""/> &nbsp&nbsp
								연락처 <input type="text" name="massage_hp" size="10" maxlength="10" value=""/> 
							</td>
						</tr>
						<tr>
							<th>방문간호사</th>
							<td>산전 <input type="text" name="Q14_1" size="10" maxlength="10" value="<%=product_VISIT_NURSE_BEFORE%>"/> 회 &nbsp&nbsp
								...
								담당자 <input type="text" name="Q14_mng" size="10" maxlength="10" value=""/> &nbsp&nbsp
								연락처 <input type="text" name="Q14_hp" size="10" maxlength="10" value=""/> 
							</td>
						</tr>
						<tr>
							<th>소독서비스</th>
							<td><select name="Q15_Y" >
								...
								담당자 <input type="text" name="Q15_mng" size="10" maxlength="10" value=""/> &nbsp&nbsp&nbsp&nbsp
								연락처 <input type="text" name="Q15_hp" size="10" maxlength="10" value=""/> 
							</td>
						</tr>
 ...
 <% End If %>
			...
			<tr>
				<th>가족사항</th>	
				<td>
					<input type="checkbox" name="check3" value="미취학아동1명" <%If InStr(family,"미취학아동1명") > 0 Then%>checked<%End If%>/> 미취학아동 1명&nbsp;&nbsp;
					<input type="checkbox" name="check3" value="미취학아동2명" <%If InStr(family,"미취학아동2명") > 0 Then%>checked<%End If%>/> 미취학아동 2명&nbsp;&nbsp;
					<input type="checkbox" name="check3" value="미취학아동3명" <%If InStr(family,"미취학아동3명") > 0 Then%>checked<%End If%>/> 미취학아동 3명&nbsp;&nbsp;
					<input type="checkbox" name="check3" value="미취학아동4명" <%If InStr(family,"미취학아동4명") > 0 Then%>checked<%End If%>/> 미취학아동 4명&nbsp;&nbsp;
					<input type="checkbox" name="check3" value="미취학아동5명" <%If InStr(family,"미취학아동5명") > 0 Then%>checked<%End If%>/> 미취학아동 5명&nbsp;&nbsp;<br>
					<input type="checkbox" name="check3" value="취학아동1명" <%If InStr(family,"취학아동1명") > 0 Then%>checked<%End If%>/> 취학아동 1명&nbsp;&nbsp;
					<input type="checkbox" name="check3" value="취학아동2명" <%If InStr(family,"취학아동2명") > 0 Then%>checked<%End If%>/> 취학아동 2명&nbsp;&nbsp;
					<input type="checkbox" name="check3" value="취학아동3명" <%If InStr(family,"취학아동3명") > 0 Then%>checked<%End If%>/> 취학아동 3명&nbsp;&nbsp;
					<input type="checkbox" name="check3" value="취학아동4명" <%If InStr(family,"취학아동4명") > 0 Then%>checked<%End If%>/> 취학아동 4명&nbsp;&nbsp;
					<input type="checkbox" name="check3" value="취학아동5명" <%If InStr(family,"취학아동5명") > 0 Then%>checked<%End If%>/> 취학아동 5명&nbsp;&nbsp;<br>
					<input type="checkbox" name="check3" value="기타가족1명" <%If InStr(family,"기타가족1명") > 0 Then%>checked<%End If%>/> 기타가족 1명
					<input type="checkbox" name="check3" value="기타가족2명" <%If InStr(family,"기타가족2명") > 0 Then%>checked<%End If%>/> 기타가족 2명
					<input type="checkbox" name="check3" value="기타가족3명" <%If InStr(family,"기타가족3명") > 0 Then%>checked<%End If%>/> 기타가족 3명
			...
			<tr>
				<th>추가비용</th>	
				<td>
					<input type="text" name="add_payment" id="add_payment" numberonly="true" size="7" maxlength="7" value="<%If add_pay <> "" Then%><%=FormatNumber(add_pay,0)%><%End If%>" class="numberic" style="ime-mode:disabled"/> 원
				</td>
			</tr>
			<tr>
				<th>결제수단</th>	
	...
	%>
			<tr>
				...
				<td> 연장시작일   
				  ...
				  <span style="padding-left:10px;"></span>연장종료일   
  ...
  //크롬등에서 ime-mode:disabled 정상작동 되지않으므로 정규식으로 처리
   $('.numberic').keyup(function(event){
	...
	btnDel.click(function(){
		if (confirm("삭제 하시겠습니까?")) {
			...
			jQuery('#ifrm').attr({'src':'./data_res_test_sql.asp?mode=delete&idx=<%=intIDX%>'});
			}
		}
	});
   ...
   function onlyNumber(){
	...
	frm.submit(function(){
		...
		"target" : "ifrm",
		"action" : "./data_res_test_sql.asp?<%=strLnkUrl%>"
	});
